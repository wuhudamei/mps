...
//            }
        ...
        function searchList() {
            ...
            $("#searchForm").attr("action", "${ctx}/engineDepartSyntheticQuery/workerTypeInfo");
            $("#searchForm").submit();
        }
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/engineDepartSyntheticQuery/workerTypeInfoPre">工人工种数量</a></li>
</ul>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${list}" var="star" varStatus="status">
        ...
        <tr>
            <td>${fns:getStoreLabel(star.storeId,'' )} </td>
            <td>${fns:getDictLabel(star.projectMode,'project_mode' ,'' ) }</td>
