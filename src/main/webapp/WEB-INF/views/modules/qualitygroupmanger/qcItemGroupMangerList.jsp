...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/qualitygroupmanger/qcItemGroupManger/listall">检查项工人组和项目经理列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="qcItemGroupManger" action="${ctx}/qualitygroupmanger/qcItemGroupManger/listall" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>工人组长</label>
				<form:input path="workerGroupName" htmlEscape="false" maxlength="11" class="input-medium needClear"/>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="qcItemGroupManger">
			<tr>
				...
				<td>
					${qcItemGroupManger.workerGroupName}
				</td>
				<td>
					${qcItemGroupManger.workerGroupPhone}
				</td>
				<td>

					<a href="${ctx}/qualitygroupmanger/qcItemGroupManger/queryQcItemGroupIllegalDetails?workerGroupId=${qcItemGroupManger.workerGroupId}&workerGroupIllegalCount=${qcItemGroupManger.workerGroupIllegalCount}&workerGroupName=${qcItemGroupManger.workerGroupName}">
							${qcItemGroupManger.workerGroupIllegalCount}
					</a>
				...
				<td>
					...
					<a href="${ctx}/qualitygroupmanger/qcItemGroupManger/queryQcItemGroupPunishDetails?workerGroupId=${qcItemGroupManger.workerGroupId}&workerGrouPunishCount=${qcItemGroupManger.workerGrouPunishCount}&workerGroupName=${qcItemGroupManger.workerGroupName}">
							${qcItemGroupManger.workerGrouPunishCount}
					</a>

				</td>
				<td>
					<a href="${ctx}/qualitygroupmanger/qcItemGroupManger/queryQcItemGroupPunishDetails?workerGroupId=${qcItemGroupManger.workerGroupId}&workerGrouPunishCount=${qcItemGroupManger.workerGrouPunishCount}&workerGroupName=${qcItemGroupManger.workerGroupName}">
							${qcItemGroupManger.workerPunishAmount}
					</a>
				</td>
