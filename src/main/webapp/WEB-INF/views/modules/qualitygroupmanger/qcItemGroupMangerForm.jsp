...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/qualitygroupmanger/qcItemGroupManger/">检查项工人组和项目经理列表</a></li>
		<li class="active"><a href="${ctx}/qualitygroupmanger/qcItemGroupManger/form?id=${qcItemGroupManger.id}">检查项工人组和项目经理<shiro:hasPermission name="qualitygroupmanger:qcItemGroupManger:edit">${not empty qcItemGroupManger.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="qualitygroupmanger:qcItemGroupManger:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="qcItemGroupManger" action="${ctx}/qualitygroupmanger/qcItemGroupManger/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">是否限期整改：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="limitDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${qcItemGroupManger.limitDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			<label class="control-label">是否罚款：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="qualitygroupmanger:qcItemGroupManger:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
