...
<body>
	...
	<div class="container">
		...
		<div class="row clearfix">
			...
			<c:if test="${settlementCount.getManagerCount()>0}">
			    <div>
					<h3>
				...
				<div>
					...
					中期提成合计金额：<input type="text" id="allAmount"
								readonly="readonly" value="${settleAmount}" />
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td colspan="2">中期星级提成金额：<input type="text"
