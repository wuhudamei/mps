...
<head>
	...
	<script type="text/javascript">
		...
		function yes(id){
			...
			window.location.href = "${ctx}/order2/order2/resendManager?id="+id+"&managerName="+
		...
		function fanhui(){
			...
			if(hidProjectMode == "1"){
				window.location.href = "${ctx}/order2/order2/listAllot";
			}else if(hidProjectMode == "2"){
				window.location.href = "${ctx}/order2/order2/listAllotManagerTradition";
			}else{
				window.location.href = "${ctx}/order2/order2/quasiIndustryYfpxmjl";
			}
