			    	...
			    	$.ajax({
			    		...
			    		success:function(data){
			    			...
			    			if(data.itemManager == null || ""== data.itemManager){
			    				...
			    				$.ajax({
						    		url:"${ctx}/order2/order2/checkPmPreIndustry",
						    		type:"post",
						    		dataType:"json",
						    		data:{id:orderId,itemManagerId:data.itemManagerId},
						    		success:function(data){
						    			if(data>1){
						    				alert("此订单还有正在结算的结算单，不允许重新派给新的项目经理。");
						    			}else{
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/quasiIndustryYfpxmjl1">分配订单</a></li>
		<%-- <shiro:hasPermission name="order:order:edit"><li><a href="${ctx}/order/order/form">订单添加</a></li></shiro:hasPermission> --%>
	</ul>
	<ul class="ul-form">
		
	</ul>
	<form:form style="width:110%;" id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/quasiIndustryYfpxmjl1" method="post" class="breadcrumb form-search">
