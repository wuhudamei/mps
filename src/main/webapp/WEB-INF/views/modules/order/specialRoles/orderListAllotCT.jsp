...
<head>
	...
	<script type="text/javascript">
		...
		function gotoAllotPage(orderId){
			...
			window.location.href = "${ctx}/order2/order2/allotManagerTradition1?id=" + orderId ;
		}
		
		function gotoreAllotPage(orderId){
			window.location.href = "${ctx}/order2/order2/allotManagerTradition1?id=" + orderId+"&tradition="+1 ;
		}
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/listAllotManagerTraditionCT?firstRequest=1">分配订单</a></li>
		<%-- <shiro:hasPermission name="order:order:edit"><li><a href="${ctx}/order/order/form">订单添加</a></li></shiro:hasPermission> --%>
	</ul>
	<ul class="ul-form">
		
	</ul>
	<form:form style="width:110%;" id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/listAllotManagerTraditionCT1" method="post" class="breadcrumb form-search">
