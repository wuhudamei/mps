...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/listAllotCY">分配订单</a></li>
		<%-- <shiro:hasPermission name="order:order:edit"><li><a href="${ctx}/order/order/form">订单添加</a></li></shiro:hasPermission> --%>
	</ul>
	<ul class="ul-form">
		
	</ul>
	<form:form style="width:110%;" id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/listAllotCY1" method="post" class="breadcrumb form-search">
