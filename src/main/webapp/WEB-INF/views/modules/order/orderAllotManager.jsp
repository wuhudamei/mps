...
<head>
	...
	<script type="text/javascript">
		...
		function save(id,storeId,communityName,buildNumber,buildUnit,buildRoom,designerName,designerPhone,customerName,customerPhone){
		    ...
		    if(size == 1){	
		    	window.location.href = "${ctx}/order2/order2/saveManager?id="+id+"&managerName="+employeeName+"&managerId="+employeeId+"&managerPhone="+managerPhone;
		...
		function fanhui(){
			...
			if(hidProjectMode == "1"){
				window.location.href = "${ctx}/order2/order2/listUnAllot";
			}else if(hidProjectMode == "2"){
				window.location.href = "${ctx}/order2/order2/listUnAllotManagerTradition";
			}else{
				window.location.href = "${ctx}/order2/order2/quasiIndustryDfpxmjl";
			}
