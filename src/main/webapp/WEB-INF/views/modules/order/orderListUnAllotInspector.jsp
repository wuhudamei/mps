...
<head>
	...
	<script type="text/javascript">
		...
		function getUnAllotInspector(){
			$("#unAllotCount").html('');
			$.ajax({
				url:'${ctx}/order2/order2/getUnAllotInspector?projectModel=1',
				type:'post',
				dataType : 'json',
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/listUnAllotInspector">分配订单</a></li>
		<%-- <shiro:hasPermission name="order:order:edit"><li><a href="${ctx}/order/order/form">订单添加</a></li></shiro:hasPermission> --%>
	</ul>
	<ul class="ul-form">
		
	</ul>
	<form:form id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/listUnAllotInspector1" method="post" class="breadcrumb form-search">
