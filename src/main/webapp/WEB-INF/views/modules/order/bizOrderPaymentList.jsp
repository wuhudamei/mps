...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/orderPaymentList">订单付款状态查询列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="order" action="${ctx}/order2/order2/orderPaymentList" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>付款状态：</label>
				<form:select path="paymentStatus" class="input-medium needClear">
					<form:option value="" label=""/>
					<form:option value="0" label="全部"/>
					<form:option value="1" label="未付款"/>
					<form:option value="2" label="付款中"/>
					<form:option value="3" label="已付款"/>
				</form:select>
			</li>
