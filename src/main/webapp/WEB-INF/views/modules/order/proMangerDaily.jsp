...
<c:set var="user" value="${fns:getUser()}"></c:set>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/proMangerDailyList">订单列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/proMangerDailyList" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li style="font-size:25px;font-weight:bold;">门店当前待派项目经理订单：<span style="font-size:25px;font-weight:bold;color:red;" id="unAllotCount">${proMangerCount }</span></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<th>门店</th>
				<th>区域</th>
				<th>当前未分派分派项目经理订单数</th>
				<th>选择日期已分派项目经理订单数</th>
			</tr>
		</thead>
		<tbody>
