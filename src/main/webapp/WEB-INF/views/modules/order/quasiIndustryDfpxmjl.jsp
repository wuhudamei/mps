...
<body>
	...
	<form:form id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/quasiIndustryDfpxmjl1" method="post" class="breadcrumb form-search">
...
<form:form id="jvForm">
	...
	<script type="text/javascript">
		...
		function getUnAllotCount(){
			$("#unAllotCount").html('');
			$.ajax({
				url:'${ctx}/order2/order2/getUnAllotCount?projectModel=4',
				type:'post',
				dataType : 'json',
