...
<head>
	...
	<script type="text/javascript">
		...
		function gotoAllotInspectorPage(orderId){
			window.location.href = "${ctx}/order2/order2/allotInspectorTradition?id=" + orderId ;
		}
		function gotoreAllotInspectorPage(orderId){
			window.location.href = "${ctx}/order2/order2/allotInspectorTradition?id=" + orderId+"&tradition="+1  ;
		}
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/listAllotInspectorTradition">分配订单</a></li>
		<%-- <shiro:hasPermission name="order:order:edit"><li><a href="${ctx}/order/order/form">订单添加</a></li></shiro:hasPermission> --%>
	</ul>
	<ul class="ul-form">
		
	</ul>
	<form:form style="width:110%;" id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/listAllotInspectorTradition1" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
		 ...
		 <ul class="ul-form ul1">
			...
			<li class="btns"><input id="btnSubmit" class="btn btn-primary clearBtn" type="button" value="清除" onclick="clearCondition()"/></li>
			<!--<li class="btns"><input id="btnAllotManager" class="btn btn-primary" type="button" value="分配项目经理" onclick="allotManager()"/></li>
			<li class="btns"><input id="btnClearManager" class="btn btn-primary" type="button" value="重派项目经理" onclick="allotManager()"/></li>-->
