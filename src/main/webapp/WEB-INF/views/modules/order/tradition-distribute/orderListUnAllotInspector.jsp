...
<head>
	...
	<script type="text/javascript">
		...
		function getUnAllotInspector(){
			$("#unAllotCount").html('');
			$.ajax({
				url:'${ctx}/order2/order2/getUnAllotInspectorType2',
				type:'post',
				dataType : 'json',
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order2/order2/listUnAllotInspectorTradition">分配订单</a></li>
		<%-- <shiro:hasPermission name="order:order:edit"><li><a href="${ctx}/order/order/form">订单添加</a></li></shiro:hasPermission> --%>
	</ul>
	<ul class="ul-form">
		
	</ul>
	<form:form id="searchForm" modelAttribute="order2" action="${ctx}/order2/order2/listUnAllotInspectorTradition1" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
		 ...
		 <ul class="ul-form ul1">
		 	<li style="font-size:25px;font-weight:bold;text-align:center;">待分配质检员订单：<span style="font-size:25px;font-weight:bold;text-align:center;color:red;" id="unAllotCount"></span></li>
