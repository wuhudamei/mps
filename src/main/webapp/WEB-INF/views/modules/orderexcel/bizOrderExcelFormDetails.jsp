...
<body>
	...
	<form:form id="inputForm" modelAttribute="bizOrderExcel" action="${ctx}/orderexcel/bizOrderExcel/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="fileName" htmlEscape="false" maxlength="100" class="input-xlarge required" disabled="true"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="filePath" type="excels" uploadPath="/orderexcel/bizOrderExcel" selectMultiple="true" readonly="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">备注：</label>
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge required" disabled="true"/>
			</div>
		</div>
