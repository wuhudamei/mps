...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/standradmaterials/bizMaterialsStandard/list">标化辅材列表</a></li>
		<li class="active"><a href="${ctx}/standradmaterials/bizMaterialsStandard/form?id=${bizMaterialsStandard.id}">标化辅材<shiro:hasPermission name="standradmaterials:bizMaterialsStandard:edit">${not empty bizMaterialsStandard.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="standradmaterials:bizMaterialsStandard:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bizMaterialsStandard" action="${ctx}/standradmaterials/bizMaterialsStandard/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">申请上限 ：</label>
			<div class="controls">
				<form:input path="maxReceiveNumber" htmlEscape="false"  
		...
		<div class="form-actions">
			<shiro:hasPermission name="standradmaterials:bizMaterialsStandard:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
