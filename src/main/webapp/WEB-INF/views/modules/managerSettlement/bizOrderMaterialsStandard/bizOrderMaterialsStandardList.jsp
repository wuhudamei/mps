...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/orderMaterialsStandard/bizOrderMaterialsStandard/list">申请记录列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizOrderMaterialsStandardQuery" action="${ctx}/orderMaterialsStandard/bizOrderMaterialsStandard/findlist" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="bizOrderMaterialsStandardQuery">
			<tr>
				...
				<td>
					<a href="${ctx}/orderMaterialsStandard/bizOrderMaterialsStandard/form?orderId=${bizOrderMaterialsStandardQuery.orderId}">详情</a>
				</td>
