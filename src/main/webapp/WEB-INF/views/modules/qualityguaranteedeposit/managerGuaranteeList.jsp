...
<body>
	...
	<form:form id="searchForm" modelAttribute="bizGuaranteeMoneyBalance"
		action="${ctx}/guarantee/guaranteeManager2/queryManagerGuarantee"
		...
		<ul class="ul-form">
			...
			<li><label>项目经理：</label> <form:input path="empName"
		...
		<tbody>
			<c:forEach items="${page.list}" var="bizGuaranteeMoneyBalance">
				<tr>
					...
					<td><a href="${ctx}/guarantee/guaranteeManager2/queryManagerGuaranteePaidSettleDetail?usedEmployeeId=${bizGuaranteeMoneyBalance.employeeId}">${bizGuaranteeMoneyBalance.guaranteeMoneyAmountPaidSettle}</a></td>
					<td><a href="${ctx}/guarantee/guaranteeManager2/queryManagerGuaranteePaidOffineDetail?usedEmployeeId=${bizGuaranteeMoneyBalance.employeeId}">${bizGuaranteeMoneyBalance.guaranteMoneyAmountPaidOffline}</a></td>
					<td><a href="${ctx}/guarantee/guaranteeManager2/queryManagerGuaranteeUsedDetail?usedEmployeeId=${bizGuaranteeMoneyBalance.employeeId}">${bizGuaranteeMoneyBalance.guaranteeMoneyAmountPaidUsed}</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
