...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/guarantee/guaranteeManager/queryPaidGuarantee">质保金上缴查询</a></li>
		<li><a
			href="${ctx}/guarantee/guaranteeManager/openPaidGuaranteeFrom">质保金上缴信息添加</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizGuaranteeMoneyPaidUsed"
		action="${ctx}/guarantee/guaranteeManager/queryPaidGuarantee"
		...
		<tbody>
			<c:forEach items="${page.list}" var="bizGuaranteeMoneyPaidUsed">
				<tr>
					...
					<td><a
						href="${ctx}/guarantee/guaranteeManager/openPaidGuaranteeUpdate?id=${bizGuaranteeMoneyPaidUsed.id}">修改</a>
						<a
						href="${ctx}/guarantee/guaranteeManager/getPaidGuaranteeDetail?id=${bizGuaranteeMoneyPaidUsed.id}">详情</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
