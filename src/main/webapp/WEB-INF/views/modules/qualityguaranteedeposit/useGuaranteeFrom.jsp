...
$(document).ready(function() {
	...
	$("#inputForm").validate({
		submitHandler : function(form) {
			...
			if(parseFloat(guaranteeMoney)>parseFloat(guaranteeMoneyBalance)){
				alertx("质保金金额不能大于余额！");
			}else{
				loading('正在提交，请稍等...');
				$("#btnSubmit").attr(
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a
			href="${ctx}/guarantee/guaranteeManager/openUseGuaranteFrom">质保金使用添加</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="bizGuaranteeMoneyPaidUsed"
		action="${ctx}/guarantee/guaranteeManager/saveUseGuarantee" method="post" class="form-horizontal">
		<form:hidden path="id" />
		<input type="hidden" name="guaranteeMoneyType" value="2"/>
