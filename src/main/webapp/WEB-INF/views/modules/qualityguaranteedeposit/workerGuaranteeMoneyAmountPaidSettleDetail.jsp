...
<form:form id="searchForm" modelAttribute="bizGuaranteeMoneyPaidUsed"
		action="${ctx}/guarantee/guaranteeWorker3/queryWorkerGuaranteePaidSettleDetail"
	...
	<table id="contentTable"
		...
		<tbody>
		   ...
		   <tr>
				...
				<td>${bizGuaranteeMoneyPaidUsed.customerAddress}-${bizGuaranteeMoneyPaidUsed.customerName}</td>
			    <td>${bizGuaranteeMoneyPaidUsed.packageName}</td>
			</tr>
		   </c:forEach>
		</tbody>
	</table>
