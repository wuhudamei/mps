	...
	<script type="text/javascript">
		...
		function exportExcel(date){
			if(date==''){
				...
				$("#searchForm").submit();
	            $("#searchForm").attr("action", "${ctx}/auxiliarymaterials/bizAuxiliaryMaterials/supplierList");
			}
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/auxiliarymaterials/bizAuxiliaryMaterials/supplierList">辅料管理列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizAuxiliaryMaterials" action="${ctx}/auxiliarymaterials/bizAuxiliaryMaterials/supplierList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>状态</th>
				<th>品牌</th>
				<shiro:hasPermission name="auxiliarymaterials:bizSupplierListAuxiliaryMaterials:edit">
				<th>操作</th>
		...
		<c:forEach items="${page.list}" var="bizAuxiliaryMaterials">
			<tr>
				...
				<shiro:hasPermission name="auxiliarymaterials:bizSupplierListAuxiliaryMaterials:edit">
				<td>
    				<a href="${ctx}/auxiliarymaterials/bizAuxiliaryMaterials/supplierForm?id=${bizAuxiliaryMaterials.id}">修改基本信息</a>
    				<a href="${ctx}/auxiliarymaterialssupplier/bizAuxiliaryMaterialsSupplierRel/supplierList?auxiliaryMaterialsId=${bizAuxiliaryMaterials.id}">修改供应商价格</a>
    			</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
