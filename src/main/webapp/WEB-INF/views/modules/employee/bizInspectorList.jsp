...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/employee/bizEmployee/inspector_list?empType=1">质检员信息</a></li>
		<shiro:hasPermission name="inspector:bizInspector:edit"><li><a href="${ctx}/employee/bizEmployee/inspector_form">新增质检员</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="bizEmployee" action="${ctx}/employee/bizEmployee/inspector_list?empType=1" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="bizEmployee">
			<tr>
				...
				<td><a href="${ctx}/employee/bizEmployee/inspector_form?id=${bizEmployee.id}">
					${bizEmployee.no}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="inspector:bizInspector:edit"><td>
    				<a href="${ctx}/employee/bizEmployee/inspector_form?id=${bizEmployee.id}">修改</a>
					<a href="${ctx}/employee/bizEmployee/inspector_delete?id=${bizEmployee.id}" onclick="return confirmx('确认要删除该员工信息吗？', this.href)">删除</a>
