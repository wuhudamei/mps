...
<script type="text/javascript">
    ...
    function() {
    	...
    	var userProjectMode = $("#userProjectMode").val();
    	...
    	$("#inputForm").validate({
    		...
    		messages : {
    			...
    			nps : "请输入NPS",
    			orderstop : "请选择是否停单",
    			iswebchat : "请选择是否会使用微信",
    			smartphone : "请选择是否会使用智能手机",
    		},
	...
	//var storeid = '${bizEmployee.storeid}';
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/employee/bizEmployee/manager_list?empType=3">项目经理信息</a></li>
		<li class="active"><a
			href="${ctx}/employee/bizEmployee/manager_form?id=${bizEmployee.id}">${not empty bizEmployee.id?'修改':'添加'}项目经理<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="bizEmployee"
		action="${ctx}/employee/bizEmployee/manager_save" method="post"
		...
		<input id = "userProjectMode" value="${userProjectMode }" style="display: none;">
		...
		<table>
				...
				<td>
					<div class="control-group">
						...
						<div class="controls project">
                               	 <form:radiobuttons path="projectMode" items="${fns:getDictList('pre_employee_project_mode')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                                <span class="help-inline"><font color="red">*</font></span>
						</div>
					</div>
				</td>	
			...
			<tr>
				<td><div class="control-group">
						...
						<div class="controls">
							<form:input path="no" htmlEscape="false" maxlength="18"
				...
				<td><div class="control-group">
						...
						<div class="controls">
							<form:input path="realname" htmlEscape="false" maxlength="255"
								class="input-medium" />
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div></td>
			...
			<tr>
				<td><div class="control-group">
						...
						<div class="controls">
							<form:input path="loginname" htmlEscape="false" maxlength="255"
								class="input-medium" />
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div></td>
				...
				<td><div class="control-group">
						...
						<div class="controls">
							<input name="entrytime" type="text" readonly="readonly"
								...
								onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});" /><span
			...
			<tr>
				<td><div class="control-group">
						...
						<div class="controls">
							<form:select path="empType" class="input-medium" disabled="true"
								id="empType" name="empType">
								<form:option value="" label="" />
								<form:option value="3" label="项目经理" selected="selected" />
							</form:select>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div></td>
			...
			<tr>
				<td><div class="control-group">
						...
						<div class="controls">
							<form:input path="age" htmlEscape="false" maxlength="3" class="input-medium digits" />
						</div>
					</div></td>
				<td><div class="control-group">
			...
			<tr>
                ...
                <td>
					<div class="control-group">
						...
						<div class="controls">
							<form:hidden id="headpic" path="headpic" htmlEscape="false"
								maxlength="128" class="input-xlarge" />
							<sys:ckfinder input="headpic" type="images"
								uploadPath="/upload/employeeHeadPic" selectMultiple="false" />
						</div>
		...
		<table>
			<tr>
				<td><div class="control-group">
						...
						<div class="controls">
							<form:select path="star" class="input-medium required">
								<form:option value="" label="" />
								<form:options items="${fns:getDictList('manager_star')}"
									itemLabel="label" itemValue="value" htmlEscape="false" />
							</form:select>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
				...
				<td><div class="control-group">
						...
						<div id="orderarea" class="controls required"></div><span class="help-inline"><font color="red">*</font> </span>
					</div>
					</td>
				<script>
					storeClick();
			...
			<tr>
				...
				<td><div class="control-group">
						<label class="control-label">接单新老房：</label>
						<div class="controls">
							<form:select path="housetype" class="input-medium required">
								<form:option value="" label="" />
								<form:options items="${fns:getDictList('biz_order_is_new_house')}"
									itemLabel="label" itemValue="value" htmlEscape="false" />
							</form:select>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
			...
			<tr>
				...
				<td><div class="control-group">
						...
						<div class="controls required">
							<form:radiobuttons path="orderstop"
			...
			<tr>
				<td><div class="control-group">
						...
						<div class="controls required">
							<form:radiobuttons path="iswebchat"
								items="${fns:getDictList('yes_no')}" itemLabel="label"
								itemValue="value" htmlEscape="false" class="" />
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
				...
				<td><div class="control-group">
						...
						<div class="controls required">
							<form:radiobuttons path="smartphone"
								items="${fns:getDictList('yes_no')}" itemLabel="label"
								itemValue="value" htmlEscape="false" class="" />
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
