...
<body>
	<ul class="nav nav-tabs">
		<li><a
			href="${ctx}/employee/bizEmployee/inspector_list?empType=1">质检员信息</a></li>
		<li class="active"><a
			href="${ctx}/employee/bizEmployee/inspector_form?id=${bizEmployee.id}">${not empty bizEmployee.id?'修改':'添加'}质检员<shiro:hasPermission
					name="employee:bizInspector:edit">${not empty bizEmployee.id?'修改':'添加'}</shiro:hasPermission>
				<shiro:lacksPermission name="inspector:bizInspector:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="bizEmployee"
		action="${ctx}/employee/bizEmployee/inspector_save" method="post"
		...
		<table>
			...
			<tr>
				<td><div class="control-group">
						...
						<div class="controls">
							<form:select path="empType" class="input-xlarge " disabled="true">
								<form:option value="1" label="质检员" />
							</form:select>
						</div>
					</div></td>
		...
		<table>
			<tr>
				...
				<td><div class="control-group">
						...
						<div id="orderarea" class="controls required"></div>
						<span class="help-inline"><font color="red">*</font> </span>
					</div></td>
				<script>
					storeClick();
