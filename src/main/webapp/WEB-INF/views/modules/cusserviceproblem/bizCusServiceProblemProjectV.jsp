...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ordercomplan/bizOrderComplaint/list">投诉问题列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizCusServiceProblem" action="${ctx}/order/order/listProject" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<input id="pageSize" name="id" type="hidden" value="${bizCusServiceProblem.storeId}"/>
		<ul class="ul-form">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="findList">
			<tr>
				...
				<td>
	    		<a href="${ctx}/cusserviceproblem/bizCusServiceProblem/ProjectbyId?id=${findList.id}">选择</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
