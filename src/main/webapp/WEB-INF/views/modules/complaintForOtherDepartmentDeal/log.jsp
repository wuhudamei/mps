                ...
                <div class="basic_content">
                    ...
                    <ul class="clearfix info_cont">
                        <li class="fl"><span class="fl">附件 :</span><span class="ml12 content_info"><a
                                href="${ctx}/complaintforotherdepartment/complaintForOtherDepartMent/photo?id=${preComlaint.id}">点击查看图片</a></span></li>
                    </ul>
                </div>

            </div>

            <c:if test="${preComlaint.complaintStatus!=10}">
                        ...
                        <div class="basic_content">
                            <ul class="clearfix">
                                <li class="fl"><span>操作时间 :</span><span class="ml12"><fmt:formatDate
                                        value="${preComlaint.stausDateTime}"
                            ...
                            <ul class="clearfix info_cont">
                                <li class="fl"><span class="fl">内容 :</span><span
                                        class="ml12 content_info">${item.statusDescribe}</span></li>
                            </ul>
