...
<body>
	<ul class="nav nav-tabs">
	   <li><a href="${ctx}/verify/bizAuxiliaryMaterialsVerify/list">对账单列表</a></li>
		<li class="active"><a
			href="#">对账单详情</a></li>
	</ul>
	...
	<div class="control-group">
		...
		<span>${verify.auxiliaryMaterialsSupplierPriceAmount}</span>&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tbody>
			<c:forEach items="${page.list}" var="verifyAuxi" varStatus="status">
				<tr>
					...
					<td>${verifyAuxi.auxiliaryMaterialsSupplierPriceAmount}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
