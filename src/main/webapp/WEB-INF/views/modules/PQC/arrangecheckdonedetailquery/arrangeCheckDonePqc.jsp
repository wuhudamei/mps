...
<body>
	<div class="g-photo">
		<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/bizorderrecheck/bizOrderRecheck/list">约检验收上传图片</a></li>
		</ul>
		<header>
		...
		<div class="swiper-wrapper">
			<c:forEach items="${picList }" var="picUrl">
				<div class="swiper-slide">
					<img src="${pageContext.request.contextPath}${picUrl}" alt="约检验收上传图片">
				</div>
			</c:forEach>
			</div>
