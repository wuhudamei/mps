...
<body>
	<div class="g-photo">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:void(0)">质检罚款修改图片</a></li>
		</ul>
		<header>
			<!-- <h2 class="title"></h2> -->
			<a class="back" onclick="window.location.href = document.referrer;" href="window.location.href = document.referrer;">返回</a>
		</header>
		<section class="swiper-container">
			<div class="swiper-wrapper">
			<c:forEach items="${pictures }" var="picture">
				<div class="swiper-slide" style="display:table">
				<p style="vertical-align:middle; display:table-cell">	<img src="${baseUrl }${picture.picUrl}" alt="图片加载中..."></p>
				</div>
			</c:forEach>
			</div>
