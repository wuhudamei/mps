...
<script type="text/javascript">
	...
	function initMoney(type) {
		...
		if(packagedPrice == null || packagedPrice == ''){
			packagedPrice = 0;
		}
		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				...
				<form id="inputSubmit" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/saveContractTotal">
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>计价面积：<input type="text" id="packagedSquare"
						...
						<tr>
							<td>结算单价：<input type="text" name="packagedPrice"
								id="packagedPrice"
								value="${contractSettle.packagedPrice}" oninput="this.value=this.value.replace(/[^\d\.]/g,'');initMoney()"> 元/m²
							</td>
						</tr>
