		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				<form id="inputSubmit" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/saveOrderMaterialCarryCost">
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>材料搬运及运输费：<input type="text" id="carryCostAmount"
						...
						<tr>
							<td>结算比例：<input type="text" name="accountRate"
								id="accountRate"
								value="${bizOrderMaterialCarryCost.accountRate}" oninput="this.value=this.value.replace(/[^\d\.]/g,'');initMoney()"> %
							</td>
						</tr>
						...
						<tr>
						  <td>材料搬运及运输费说明：<textarea name="carryCostRemarks">${bizOrderMaterialCarryCost.carryCostRemarks}</textarea></td>
						</tr>
					</table>
				</form>
			</div>
