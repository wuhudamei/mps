		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				<form id="inputSubmit" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/saveBaseInstalled">
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>中期奖励金额：<input type="text" id="changeAmount"
								name="changeAmount" value="${bizOrderChange.changeAmount}">元
							</td>
						</tr>
						
						<tr>
						  <td>中期奖励说明：<textarea name="changeRemarks">${bizOrderChange.changeRemarks}</textarea></td>
						</tr>
					</table>
				</form>
			</div>
