...
<head>
	...
	<script type="text/javascript">
		...
		function openMidwaySettleInfoPage(orderId){
			window.location.href="${ctx}/newProIndustryPmSettle/openMidwaySettleInfoPage?orderId="+orderId;
		}
	</script>
</head>
<body>
	...
	<form:form id="searchForm" modelAttribute="proIndustryPmSettleInfo" action="${ctx}/newProIndustryPmSettle/queryProIndustryPmMidwaySettleList" method="post" class="breadcrumb form-search">
