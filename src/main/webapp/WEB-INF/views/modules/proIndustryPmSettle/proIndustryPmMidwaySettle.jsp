...
<head>
	...
	<script type="text/javascript">
		...
		function openTaskPackPayment(orderId){
			window.location.href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/queryTaskpackPaymentInfo?orderId="+orderId;
		}
		
		function openMidwaySettleInfoPage(orderId){
			window.location.href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openMidwaySettleInfoPage?orderId="+orderId;
		}
	</script>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">项目经理中期结算信息</a></li>
	</ul>
	<br/>
	
	
	<form:form id="searchForm" modelAttribute="proIndustryPmSettleInfo" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/queryProIndustryPmMidwaySettleList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="proIndustryPmSettleInfo">
			<tr>
				...
				<td>
					<fmt:formatDate value="${proIndustryPmSettleInfo.acceptCheckDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${proIndustryPmSettleInfo.secondPayment}
				</td>
				
				<td>
					<fmt:formatDate value="${proIndustryPmSettleInfo.secondPaymentDate}" pattern="yyyy-MM-dd"/>
				</td>
				
				<td>
				  <a href="#" onclick="openTaskPackPayment(${proIndustryPmSettleInfo.orderId})">查看</a>
				</td>
				
				<td>
				 <a href="#" onclick="openMidwaySettleInfoPage(${proIndustryPmSettleInfo.orderId})">创建结算单</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
