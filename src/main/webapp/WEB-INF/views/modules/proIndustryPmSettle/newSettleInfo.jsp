...
<script type="text/javascript">
	...
	function initMoney(){
        ...
        var midwayCompleteGuaranteeMoneyAmount = "${completeGuaranteeMoneyAmount}";
		var settleRule = 0;
...
//           中期实际结算金额
	...
	function brank(){
		window.location.href="${ctx}/newProIndustryPmSettle/queryProIndustryPmMidwaySettleList?storeId="+${order2.storeId};
	}
</script>
</head>
<body>
	...
	<div class="container">
		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				...
				<form id="inputSubmit"
					action="${ctx}/newProIndustryPmSettle/createMidwaySettleBille">
					...
					<table class="table table-striped table-bordered table-condensed">
						...
						<tbody>
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openContractTotal?orderId=${order2.id}&settleStage=10&isEditSettleBill=0">修改</a></td>
							</tr>
							...
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openBaseInstalled?orderId=${order2.id}&changeType=10&isEditSettleBill=0">添加</a></td>
							</tr>
							...
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openPmRewardPunish?orderId=${order2.id}&rewardPunishType=1&relatedBusinessType=1&isEditSettleBill=0">添加</a></td>
							</tr>
							...
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openPmRewardPunish?orderId=${order2.id}&rewardPunishType=2&relatedBusinessType=1&isEditSettleBill=0">添加</a></td>
							</tr>
							...
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openOrderMaterialCarryCost?orderId=${order2.id}&isEditSettleBill=0">添加</a></td>
							</tr>
							...
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openBaseInstalled?orderId=${order2.id}&changeType=20&isEditSettleBill=0">添加</a></td>
							</tr>
							...
							<tr>
								...
								<td><a
									href="${ctx}/proIndustryPmSettle/proIndustryPmSettle/openBaseInstalled?orderId=${order2.id}&changeType=30&isEditSettleBill=0">添加</a></td>
							</tr>
                            <tr>
								<td>质保金</td>
							...
							<tr>
								<td colspan="3"><label>结算说明： <br />
                                    中期承包价结算金额 = 【承包总价 + 基装增项  - 辅料 - 沙子水泥 - 标化材料 - 开关面板 - 工人人工费  + 中期奖励 + 材料搬运及运输费 + 中期变更增项 - 中期质检罚款 - 中期变更减项  - 中期扣款 - 质保金】* ${bizNormalPmSettleNode.settleRule}% <br>
                                    中期实际结算金额 = 【承包总价 + 基装增项  - 辅料 - 沙子水泥 - 标化材料 - 开关面板 - 工人人工费  + 中期奖励 + 材料搬运及运输费 + 中期变更增项 - 中期质检罚款 - 中期变更减项  - 中期扣款 - 质保金】* ${bizNormalPmSettleNode.settleRule}%
                                </label></td>
							</tr>
						</tbody>
					</table>
