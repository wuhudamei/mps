		...
		<div>
			...
			<div class="row clearfix">
				...
				<table style="width:100%" align="center" valign="center" class="table table-striped table-bordered table-condensed">
					<tr>
						<td style="width:50%"><label>订单编号：</label>${bizMaterialsSortedByOrder.orderNumber}</td>
						<td style="width:50%"><label>工程模式：</label>${fns:getDictLabel(bizMaterialsSortedByOrder.projectMode,'project_mode', '')}</td>
					</tr>
					<tr>
						<td style="width:50%"><label>区域：</label>${bizMaterialsSortedByOrder.enginDepartName}</td>
						<td style="width:50%"><label>项目经理：</label>${bizMaterialsSortedByOrder.itemManager}</td>
					</tr>
					<tr>
						<td style="width:50%"><label>申请辅料次数：</label>${bizMaterialsSortedByOrder.applyTimes}</td>
						<td style="width:50%"><label>订单状态：</label>${bizMaterialsSortedByOrder.orderStatus}</td>
					</tr>
					<tr>
						<td style="width:50%"><label>客户姓名：</label>${bizMaterialsSortedByOrder.customerName}</td>
						<td style="width:50%"><label>客户地址：</label>${bizMaterialsSortedByOrder.customerAddress}</td>
					</tr>
				</table>
			</div>
			<div class="row clearfix">
