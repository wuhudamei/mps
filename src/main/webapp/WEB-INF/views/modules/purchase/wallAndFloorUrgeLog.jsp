	...
	<head>
		...
		<script type="text/javascript">
			function fanhui(){
				...
				window.location.href = "${ctx}/purchase/bizPurchaseMainTile/tileList";
			}
		</script>
	</head>
	<body>
	    <ul class="nav nav-tabs">                                                                                      
			...
			<li class="active"><a href="javascript:void(0)">墙地砖催促信息</a></li>
		</ul>  
		<ul class="ul-form breadcrumb">
			<li class="btns"><input class="btn btn-primary" type="button" value="返回" onclick="fanhui()"/></li>
		</ul>
		<div class="container">
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						<tr>
							<td width="50%">
								小区：${bizPurchaseMainTile.communityName }-${bizPurchaseMainTile.buildNumber }-${bizPurchaseMainTile.buildUnit }-${bizPurchaseMainTile.buildRoom }
							</td>
							<td width="50%">
								客户姓名：${bizPurchaseMainTile.customerName }
							</td>
						</tr>
						<tr>
							<td width="50%">
								客户电话：${bizPurchaseMainTile.customerPhone }
							</td>
							<td width="50%">
								采购单编号：${bizPurchaseMainTile.purchaseCode }
							</td>
						</tr>
						<tr>
							<td width="50%">
								项目经理：${bizPurchaseMainTile.itemManager }
							</td>
							<td width="50%">
								期望进场日期：<fmt:formatDate value="${bizPurchaseMainTile.applyReceiveTime }" pattern="yyyy-MM-dd"/>
							</td>
						</tr>
					</table>
				</div>
