			...
			<div class="packagesChoice_content">
				...
				<div class="basic  processesLog">
					...
					<div class="process_warp mt40">
						<h4 class="col_333 mb14">项目经理申请竣工</h4>
						<div class="basic_content">
							<ul class="clearfix">
								<li class="fl"><span>申请时间 :</span><span class="ml12"><fmt:formatDate value="${bizOrderFinishProjectBill.applyDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></span></li>
								<li class="fl ml134"><span>申请人 :</span><span class="ml12">${bizOrderFinishProjectBill.applyEmployeeName}</span></li>
							</ul>
						</div>
					</div>
