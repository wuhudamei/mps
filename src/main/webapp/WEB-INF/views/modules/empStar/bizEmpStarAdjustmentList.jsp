...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/empStar/empStarAdjustment/">工人组星级调整列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizEmployeegroupVO"
		action="${ctx}/empStar/empStarAdjustment/" method="post"
		...
		<tbody>
			<c:forEach items="${page.list}" var="bizEmployeegroup">
				<tr>
					...
					<input type="hidden" id="reason" name="bizEmployeegroup.reason" value="${bizEmployeegroup.reason}">
					<input type="hidden" id="changeDescribe" name="bizEmployeegroup.changeDescribe" value="${bizEmployeegroup.changeDescribe}">
					...
					<td>
						...
						<td><a	href="${ctx}/empStar/empStarAdjustment/form?id=${bizEmployeegroup.id}">修改</a>
						</td>
				</tr>
			</c:forEach>
		</tbody>
