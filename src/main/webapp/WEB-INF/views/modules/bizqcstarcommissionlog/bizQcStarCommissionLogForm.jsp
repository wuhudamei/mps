...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bizqcstarcommissionlog/bizQcStarCommissionLog/">质检员星级提成记录列表</a></li>
		<li class="active"><a href="${ctx}/bizqcstarcommissionlog/bizQcStarCommissionLog/form?id=${bizQcStarCommissionLog.id}">质检员星级提成记录<shiro:hasPermission name="bizqcstarcommissionlog:bizQcStarCommissionLog:edit">${not empty bizQcStarCommissionLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="bizqcstarcommissionlog:bizQcStarCommissionLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bizQcStarCommissionLog" action="${ctx}/bizqcstarcommissionlog/bizQcStarCommissionLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="commissionDatetime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${bizQcStarCommissionLog.commissionDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="bizqcstarcommissionlog:bizQcStarCommissionLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
