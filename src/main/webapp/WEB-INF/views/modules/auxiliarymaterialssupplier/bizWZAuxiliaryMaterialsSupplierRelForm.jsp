...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/auxiliarymaterialssupplier/bizAuxiliaryMaterialsSupplierRel/WZlist?auxiliaryMaterialsId=${bizAuxiliaryMaterialsSupplierRel.auxiliaryMaterialsId  }">辅料对应供应商列表</a></li>
		<li class="active"><a href="${ctx}/auxiliarymaterialssupplier/bizAuxiliaryMaterialsSupplierRel/wZform?id=${bizAuxiliaryMaterialsSupplierRel.id}">辅料对应供应商<shiro:hasPermission name="auxiliarymaterialssupplier:bizAuxiliaryMaterialsSupplierRel:edit">${not empty bizAuxiliaryMaterialsSupplierRel.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="auxiliarymaterialssupplier:bizAuxiliaryMaterialsSupplierRel:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<sys:message content="${message}"/>
	<form:form id="inputForm" modelAttribute="bizAuxiliaryMaterialsSupplierRel" action="${ctx}/auxiliarymaterialssupplier/bizAuxiliaryMaterialsSupplierRel/saveWz" method="post" class="form-horizontal">
