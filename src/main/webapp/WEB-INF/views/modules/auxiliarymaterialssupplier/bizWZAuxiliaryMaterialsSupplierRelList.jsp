...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/auxiliarymaterials/bizAuxiliaryMaterials/WZlist">辅料管理列表</a></li>
		<li class="active"><a href="${ctx}/auxiliarymaterialssupplier/bizAuxiliaryMaterialsSupplierRel/WZlist?auxiliaryMaterialsId=${bizAuxiliaryMaterialsSupplierRel.auxiliaryMaterialsId}">对应供应商列表</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="bizAuxiliaryMaterialsSupplierRel">
			<tr>
				<td><a href="${ctx}/auxiliarymaterialssupplier/bizAuxiliaryMaterialsSupplierRel/wZform?id=${bizAuxiliaryMaterialsSupplierRel.id}">
