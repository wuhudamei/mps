...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/attend/bizPmAttendMonth/bizPmAttendList">考勤月度表列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="bizPmAttendMonth" action="${ctx}/attend/bizPmAttendMonth/findPmAttendList" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="bizPmAttendMonth">
			<tr>
				...
				<shiro:hasPermission name="attend:bizPmAttendMonth:edit">
					<td>
    				<a href="${ctx}/attend/bizPmAttendSalaryBill/form?id=${bizPmAttendMonth.id}&itemManager=${bizPmAttendMonth.itemManager}&itemManagerId=${bizPmAttendMonth.itemManagerId}&storeId=${bizPmAttendMonth.storeId}&enginDepartId=${bizPmAttendMonth.enginDepartId}&attendMonth=${bizPmAttendMonth.attendMonth}">生成工资单</a>
					</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
