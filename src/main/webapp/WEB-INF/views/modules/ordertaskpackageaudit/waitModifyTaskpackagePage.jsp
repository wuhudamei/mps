...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ordertaskpackageaudit/orderTaskpackageAudit/waitModifyTaskpackagePage">待项目经理修改列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizOrderTaskpackage" action="${ctx}/ordertaskpackageaudit/orderTaskpackageAudit/waitModifyTaskpackage" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li style="width:800px">
				...
				<input type="checkbox" name="packageStateId" value="110" <c:if test="${fns:checkIsExits(bizOrderTaskpackage.packageStateId,'110')}"> checked="checked"</c:if>/>110-工人不认可分配金额
				<input type="checkbox" name="packageStateId" value="130" <c:if test="${fns:checkIsExits(bizOrderTaskpackage.packageStateId,'130')}"> checked="checked"</c:if>/>130-结算员驳回
			</li>
