...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ordertaskpackageaudit/orderTaskpackageAudit/waitConfirmSalaryPage">待工人确认薪酬列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizOrderTaskpackage" action="${ctx}/ordertaskpackageaudit/orderTaskpackageAudit/waitConfirmSalary" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li style="width:800px">
				...
				<input type="checkbox" name="packageStateId" value="100" <c:if test="${fns:checkIsExits(bizOrderTaskpackage.packageStateId,'100')}"> checked="checked"</c:if>/>100-已提交结算单且不超定额
				<input type="checkbox" name="packageStateId" value="105" <c:if test="${fns:checkIsExits(bizOrderTaskpackage.packageStateId,'105')}"> checked="checked"</c:if>/>105-已提交结算单且已复核额
			</li>
