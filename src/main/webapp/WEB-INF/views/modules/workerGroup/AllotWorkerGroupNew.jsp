...
<script type="text/javascript">
	...
	function yes(){
		...
		if(endDate==undefined ||endDate == "" ||startDate ==undefined || startDate == ""){
			...
			window.location.href = "${ctx}/AllotWorkerGroup/allotWorkerGroup/allotWorker?packageId="
					+ "${taskPackage.id}" + "&id=" + workerGroupId+"&startDate="+startDate+"&endDate="+endDate+"&isReDistribute="+isReDistribute+"&turnpageflag="+turnpageflag+"&reasonRemarks="+reasonRemarks+"&reasonType="+reasonType+"&flag=0";
	...
	<c:if test='${empty isRedistribute}'>
		...
		/* 	if ($('input:radio:checked').val() == undefined){
			...
			//待派工
				...
				window.location.href = "${ctx}/AllotWorkerGroup/allotWorkerGroup/allotWorker?packageId="
						+ "${taskPackage.id}" + "&id=" + workerGroupId+"&startDate="+startDate+"&endDate="+endDate+"&isReDistribute="+isReDistribute+"&turnpageflag="+turnpageflag+"&flag=0";
	...
	function backHistory(){
		...
		//重新分配
		if(isReDistribute == 1){
            window.location.href='${ctx}/scheduling/orderTaskpackage/workerListNew'
	...
	//分配工人组
            window.location.href='${ctx}/scheduling/orderTaskpackage/listNew'
        }
	...
	<c:if test="${empty error }">
		<div class="breadcrumb form-search">
			<form:form id="searchForm1" modelAttribute="WorkgroupVo"
				action="${ctx}/AllotWorkerGroup/allotWorkerGroup/listNew" method="post"
