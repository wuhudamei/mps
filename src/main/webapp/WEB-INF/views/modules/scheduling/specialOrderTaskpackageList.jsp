...
<script type="text/javascript">
 $(document).ready(function() {
	...
	function allotWorker(packId,managerName,packageCode,itemManagerId,projectMode){
		...
		window.location.href="${ctx}/AllotWorkerGroup/allotWorkerGroup/specialListNew?packageId="+packId+"&packageCode="+packageCode+"&itemManageName="+managerName+"&projectMode="+projectMode;
	}
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/scheduling/orderTaskpackage/specialListNew">任务包分配</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="orderTaskpackage"
		action="${ctx}/scheduling/orderTaskpackage/specialList2New" method="post"
		...
		<ul class="ul-form ul1">
			<li style="font-size:25px;font-weight:bold;text-align:center;">待分配任务包：<span style="font-size:25px;font-weight:bold;text-align:center;color:red;" id="unAllotCount">${count }</span></li>
