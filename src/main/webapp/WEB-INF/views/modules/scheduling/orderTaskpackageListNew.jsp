...
<script type="text/javascript">
 $(document).ready(function() {
	...
	function allotWorker(packId,managerName,packageCode,itemManagerId,projectMode){
		...
		window.location.href="${ctx}/AllotWorkerGroup/allotWorkerGroup/listNew?packageId="+packId+"&packageCode="+packageCode+"&itemManageName="+managerName+"&projectMode="+projectMode;
	}
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/scheduling/orderTaskpackage/listNew">任务包分配</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="orderTaskpackage"
		action="${ctx}/scheduling/orderTaskpackage/list2New" method="post"
