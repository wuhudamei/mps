...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/scheduling/orderTaskpackage/specialworkerList">派工监控</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="orderTaskpackage"
		action="${ctx}/scheduling/orderTaskpackage/specialWorkerList2New" method="post"
					...
					<shiro:hasPermission name="scheduling:orderTaskpackage:edit">
						<td style="width: 70px;">
							<c:if test="${orderTaskpackage.isOvertime=='1'}">
								<a href="${ctx}/AllotWorkerGroup/allotWorkerGroup/specialListNew?packageId=${orderTaskpackage.id}&isRedistribute=1&packageCode=${orderTaskpackage.packageCode}&itemManageName=${orderTaskpackage.itemCustomer}&projectMode=${orderTaskpackage.projectMode}">重新分派</a>
							</c:if>
