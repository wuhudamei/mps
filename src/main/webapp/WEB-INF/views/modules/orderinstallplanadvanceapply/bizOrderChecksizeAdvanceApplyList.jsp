...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/modules/orderinstallplanadvanceapply/web/bizOrderInstallPlanAdvanceApply/preChecksizeAdvanceApplyList">主材可申请复尺日期处理页面</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizOrderInstallPlanAdvanceApply" action="${ctx}/modules/orderinstallplanadvanceapply/web/bizOrderInstallPlanAdvanceApply/checksizeAdvanceApplyList" method="post" class="breadcrumb form-search">
	...
	<div class="Black undis" id="dealAlert">
		<div class="tc_center">
			...
			<div class="cen_t">
				...
				<div class="cen_tex">
					<span class="span_l">可申请复尺计划日期：</span>
	...
	<script type="text/javascript">
		...
		function dealAlertNo(){
			$.ajax({
				url: "${ctx}/modules/orderinstallplanadvanceapply/web/bizOrderInstallPlanAdvanceApply/save_checksize_advance_apply_refuse",
	            type: "post",
	            data:{
	            		id:idGlobal
	            	},
	            success: function(data) {
	            	...
	            	if(null!=data && data=="0"){
	            		$("#informBoxRemarkTwo").text("提前申请复尺【拒绝】成功");
	            		$("#informBoxTwo").show();
	            	}else if(data=="1"){
	            		$("#informBoxRemark").text("提前申请已经处理，不可重复处理");
	            		$("#informBox").show();
	            	}else{
	            		$("#informBoxRemark").text("提前申请复尺【拒绝】失败");
	            		$("#informBox").show();
	            	}
	            }
	    	})
		...
		function dealAlertYes(){
			$.ajax({
				url: "${ctx}/modules/orderinstallplanadvanceapply/web/bizOrderInstallPlanAdvanceApply/save_checksize_advance_apply_agree",
	            type: "post",
	            data:{
	            		id:idGlobal
	            	},
	            success: function(data) {
	            	...
	            	if(null!=data && data=="0"){
	            		$("#informBoxRemarkTwo").text("提前申请复尺【同意】成功");
	            		$("#informBoxTwo").show();
	            	}else if(data=="1"){
	            		$("#informBoxRemark").text("提前申请已经处理，不可重复处理");
	            		$("#informBox").show();
	            		...
	            		$("#informBoxRemark").text("提前申请复尺【同意】失败");
	            		$("#informBox").show();
	            	}
	            }
	    	})
