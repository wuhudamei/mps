...
// 								alert(listRow[0].id+":"+listRow);
			...
			function addEmployeeRow(data){
		        ...
		        + "  <td>" + data[0]. supplierNo  + "<input type='hidden' id='supplierId' name='supplierId' value=\""+data[0].id+"\"></input></td>"
		        + "  <td>" + data[0].supplierName  + "</td>"
		        + "  <td>" + data[0].contacts + "</td>"
		        + "  <td>" + data[0].contactsPhone + "</td>"
// 		        + "  <td>"
...
// 			alert(employeeId);
		...
		function getelementLth(){
			var InstallItemNameId=$('#InstallItemNameId').val();
			if(InstallItemNameId==''){
...
// 			alert(lementLenth);
		...
		function sbumitoc(){
            $("#inputForm").attr("action", "${ctx}/installandsupplier/projectInstallAndSupplier/save");
            $("#inputForm").submit();
		}
	</script>
</head>
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/installandsupplier/projectInstallAndSupplier/list">主材安装供应商设置列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="projectInstallAndSupplier" action="" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select id="storeid" path="storeid" class="input-xlarge" >
		...
		<div class="control-group">
			...
			<div class="controls">
			<form:radiobuttons onclick="getstoreAndpMode(this)"  path="projectMode" class="input-medium required" items="${fns:getDictList('project_mode')}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="projectInstallItemId"    class="input-xlarge required" id="InstallItemNameId">
	...
	<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="installandsupplier:projectInstallAndSupplier:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"  onMouseOut="getelementLth()"   onclick="sbumitoc()" value="保 存"/>&nbsp;</shiro:hasPermission>
