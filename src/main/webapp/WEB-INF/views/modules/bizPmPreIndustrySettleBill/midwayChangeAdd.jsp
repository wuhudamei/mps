...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:void(0)">中期变更增项</a></li>
	</ul>
		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				<form id="inputSubmit" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/saveBaseInstalled">
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>中期变更增项金额：<input type="text" id="changeAmount" readonly="readonly"
						...
						<tr>
							<td>结算比例：<input type="text" name="changeAccountRate"
								id="changeAccountRate" readonly="readonly"
								value="${bizOrderChange.changeAccountRate}" oninput="this.value=this.value.replace(/[^\d\.]/g,'');initMoney()"> %
							</td>
						</tr>

						<tr>
							<td>中期变更增项结算金额：<input type="text" name="changeAccountAmount"
						...
						<tr>
						  <td>中期变更增项结算说明：<textarea name="changeRemarks" readonly="readonly">${bizOrderChange.changeRemarks}</textarea></td>
						</tr>
					</table>
				</form>
			</div>
