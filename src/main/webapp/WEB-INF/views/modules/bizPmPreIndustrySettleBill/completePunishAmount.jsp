...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:void(0)">竣工扣款</a></li>
	</ul>
		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				<form id="inputSubmit" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/savePmRewardPunish">
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>竣工扣款：<input type="text" id="rewardPunishAmount" readonly="readonly"
								name="rewardPunishAmount" value="${bizBusinessRewardPunish.rewardPunishAmount}">元
							</td>
						</tr>

						<tr>
						  <td>竣工扣款说明：<textarea name="rewardPunishRemarks" readonly="readonly">${bizBusinessRewardPunish.rewardPunishRemarks}</textarea></td>
						</tr>
					</table>
				</form>
			</div>
