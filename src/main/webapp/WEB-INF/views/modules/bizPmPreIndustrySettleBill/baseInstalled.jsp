		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				<form id="inputSubmit" action="${ctx}/proIndustryPmSettle/proIndustryPmSettle/saveBaseInstalled">
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>基装增项合计金额：<input type="text" id="changeAmount" readonly="readonly"
						...
						<tr>
						  <td>基装增项结算说明：<textarea name="changeRemarks" readonly="readonly">${bizOrderChange.changeRemarks}</textarea></td>
						</tr>
					</table>
				</form>
			</div>
