...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:void(0)">中期变更减项</a></li>
	</ul>
		...
		<div class="row clearfix">
			...
			<div class="col-md-12 column">
				<form id="inputSubmit"
					...
					<table class="table table-striped table-bordered table-condensed">
						<tr>
							<td>中期变更减项金额：<input type="text" id="changeAmount" readonly="readonly"
						...
						<tr>
							<td>中期变更减项结算说明：<textarea name="changeRemarks" readonly="readonly">${bizOrderChange.changeRemarks}</textarea></td>
						</tr>
					</table>
				</form>
			</div>
