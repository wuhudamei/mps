	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th colspan="9" style="text-align: center">防盗门核尺</th>
				<th colspan="9" style="text-align: center">辅材进场</th>
				<th colspan="9" style="text-align: center">瓷砖</th>
				<th colspan="9" style="text-align: center">水电隐蔽验收</th>
				<th colspan="9" style="text-align: center">防水验收</th>
				<th colspan="9" style="text-align: center">橱柜核尺</th>
				<th colspan="9" style="text-align: center">瓦工验收</th>
				<th colspan="4" style="text-align: center">二期款（同瓦工验收日期）</th>
				<th colspan="9" style="text-align: center">基础施工验收</th>
				<th colspan="10" style="text-align: center">厨卫吊顶</th>
				<th colspan="10" style="text-align: center">洁具</th>
				<th colspan="10" style="text-align: center">五金，灯具，开关面板</th>
				<th colspan="11" style="text-align: center">橱柜</th>
				<th colspan="11" style="text-align: center">定制衣柜</th>
				<th colspan="10" style="text-align: center">壁纸</th>
				<th colspan="11" style="text-align: center">木门，铝镁门，门窗套</th>
				<th colspan="10" style="text-align: center">木地板</th>
				<th colspan="11" style="text-align: center">窗帘</th>
				<th colspan="9" style="text-align: center">竣工验收</th>
				<th colspan="3" style="text-align: center">尾款</th>
				<th colspan="10" style="text-align: center">家电</th>
				<th colspan="10" style="text-align: center">家具</th>
			...
			<tr>
				...
				<!-- 防盗门核尺 -->
				<th style="vertical-align: middle">计划提报日期</th>
				<th style="vertical-align: middle">实际提报时间</th>
				<th style="vertical-align: middle">提报延期天数</th>
				<th style="vertical-align: middle">期望进场日期</th>
				<th style="vertical-align: middle">实际进场时间</th>
				<th style="vertical-align: middle">进场延期天数</th>
				<th style="vertical-align: middle">计划完成日期</th>
				<th style="vertical-align: middle">实际完成时间</th>
				...
				<th style="vertical-align: middle">进场延期天数</th>
				<th style="vertical-align: middle">计划完成日期</th>
				<th style="vertical-align: middle">实际收货时间</th>
				<th style="vertical-align: middle">正常/延期/<br/>提前天数</th>
				<!-- 瓷砖 -->
				<th style="vertical-align: middle">计划提报日期</th>
				<th style="vertical-align: middle">实际提报时间</th>
				<th style="vertical-align: middle">提报延期天数</th>
				<th style="vertical-align: middle">期望到货日期</th>
				<th style="vertical-align: middle">实际到场时间</th>
				<th style="vertical-align: middle">到场延期天数</th>
				<th style="vertical-align: middle">计划完成日期</th>
				<th style="vertical-align: middle">实际收货时间</th>
				<th style="vertical-align: middle">正常/延期/<br/>提前天数</th>
				<!-- 水电隐蔽验收 -->
				...
				<th style="vertical-align: middle">实际提报时间</th>
				<th style="vertical-align: middle">提报延期天数</th>
				<th style="vertical-align: middle">期望验收日期</th>
				<th style="vertical-align: middle">质检上门日期</th>
				<th style="vertical-align: middle">上门延期天数</th>
				<th style="vertical-align: middle">计划验收日期</th>
				<th style="vertical-align: middle">实际验收合格日期</th>
				<th style="vertical-align: middle">正常/延期/<br/>提前天数</th>
				<!-- 防水验收 -->
				<th style="vertical-align: middle">计划提报日期</th>
				<th style="vertical-align: middle">实际提报时间</th>
				...
				<th style="vertical-align: middle">计划完成日期</th>
				<th style="vertical-align: middle">实际完成时间</th>
				<th style="vertical-align: middle">实际验收时间</th>
				<th style="vertical-align: middle">正常/延期/<br/>提前天数</th>
				<!-- 洁具	 -->
				<th style="vertical-align: middle">计划提报日期</th>
				<th style="vertical-align: middle">实际提报时间</th>
				...
				<th style="vertical-align: middle">实际提报时间</th>
				<th style="vertical-align: middle">提报延期天数</th>
				<th style="vertical-align: middle">提报核尺时间</th>
				<th style="vertical-align: middle">期望进场日期</th>
				<th style="vertical-align: middle">实际进场时间</th>
				<th style="vertical-align: middle">进场延期天数</th>
				<th style="vertical-align: middle">计划完成日期</th>
				<th style="vertical-align: middle">实际完成时间</th>
				<th style="vertical-align: middle">实际验收合格时间</th>
				<th style="vertical-align: middle">正常/延期/<br/>提前天数</th>
				<!-- 	定制衣柜-->
				<th style="vertical-align: middle">计划提报日期</th>
				<th style="vertical-align: middle">实际提报时间</th>
				<th style="vertical-align: middle">提报延期天数</th>
				<th style="vertical-align: middle">核尺时间</th>
				<th style="vertical-align: middle">期望进场日期</th>
				<th style="vertical-align: middle">实际进场时间</th>
				<th style="vertical-align: middle">进场延期天数</th>
				<th style="vertical-align: middle">计划完成日期</th>
		...
		<c:forEach items="${page.list}" var="boning">
			<tr>
				...
				<td>${boning.contractArea}</td>
				<td>${fns:getDictLabel(boning.buildType, 'emp_house_type', '')}</td>
				...
				<!-- 防盗门复尺 -->
				<td><fmt:formatDate value="${boning.node1PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node1SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node1SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node1ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node1ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node1EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node1PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node1ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node1DiffDay}</td>
				<!-- 辅材进场 -->
				<td><fmt:formatDate value="${boning.node2PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node2SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node2SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node2ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node2ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node2EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node2PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node2ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node2DiffDay}</td>
				<!-- 瓷砖-->
				<td><fmt:formatDate value="${boning.node3PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node3SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node3SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node3ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node3ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node3EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node3PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node3ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node3DiffDay}</td>
				<!-- 水电隐蔽验收-->
				<td><fmt:formatDate value="${boning.node4PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node4SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node4SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node4ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node4ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node4EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node4PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node4ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node4DiffDay}</td>
				<!-- 防水验收-->
				<td><fmt:formatDate value="${boning.node5PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node5SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node5SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node5ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node5ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node5EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node5PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node5ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node5DiffDay}</td>
				<!--橱柜核尺-->
				<td><fmt:formatDate value="${boning.node6PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node6SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node6SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node6ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node6ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node6EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node6PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node6ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node6DiffDay}</td>
				<!--瓦工验收-->
				<td><fmt:formatDate value="${boning.node7PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node7SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node7SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node7ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node7ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node7EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node7PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node7ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				...
				<!--基础施工验收-->
				<td><fmt:formatDate value="${boning.node9PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node9SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node9SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node9ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node9ActualExpectDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node9EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node9PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node9ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node9DiffDay}</td>
				<!-- 厨卫吊顶 -->
				<td><fmt:formatDate value="${boning.node10PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node10SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node10SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node10ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node10ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node10EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node10PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node10ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node10ActualCheckDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node10DiffDay}</td>
				<!-- 洁具 -->
				<td><fmt:formatDate value="${boning.node11PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node11SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node11SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node11ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node11ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node11EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node11PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node11InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node11ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node11DiffDay}</td>
				<!--五金，灯具，开关面板 -->
				<td><fmt:formatDate value="${boning.node12PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node12SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node12SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node12ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node12ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node11EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node12PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node12InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node12ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node12DiffDay}</td>
				<!--橱柜 -->
				<td><fmt:formatDate value="${boning.node13PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node13SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node13SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node13RuleDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node13ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node13ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node13EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node13PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node13InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node13ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node13DiffDay}</td>
				<!--定制衣柜 -->
				<td><fmt:formatDate value="${boning.node14PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node14SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node14SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node14RuleDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node14ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node14ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node14EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node14PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node14InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node14ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node14DiffDay}</td>
				<!--壁纸-->
				<td><fmt:formatDate value="${boning.node15PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node15SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node15SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node15ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node15ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node15EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node15PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node15InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node15ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node15DiffDay}</td>
				<!--木门，铝镁门，门窗套-->
				<td><fmt:formatDate value="${boning.node16PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node16SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node16SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node16RuleDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node16ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node16ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node16EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node16PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node16InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node16ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node16DiffDay}</td>
				<!--木地板-->
				<td><fmt:formatDate value="${boning.node17PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node17SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node17SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node17ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node17ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node17EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node17PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node17InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node17ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node17DiffDay}</td>
				<!--窗帘-->
				<td><fmt:formatDate value="${boning.node18PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node18SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node18SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node18RuleDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node18ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node18ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node18EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node18PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node18InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node18ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node18DiffDay}</td>
				<!--竣工验收-->
				<td><fmt:formatDate value="${boning.node19PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node19SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node19SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node19ExpectDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node19ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node19EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node19PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node19ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				...
				<!--家电-->
				<td><fmt:formatDate value="${boning.node21PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node21SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node21SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node21ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node21ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node21EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node21PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node21InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node21ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node21DiffDay}</td>
				<!--家具-->
				<td><fmt:formatDate value="${boning.node22PlanSubDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node22SubmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node22SubDiffDay}</td>
				<td><fmt:formatDate value="${boning.node22ApplyEntryDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node22ActualEntryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${boning.node22EntryDiffDay}</td>
				<td><fmt:formatDate value="${boning.node22PlanDate}" pattern="yyyy-MM-dd"/></td>
				<td><fmt:formatDate value="${boning.node22InstallDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${boning.node22ActualDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
