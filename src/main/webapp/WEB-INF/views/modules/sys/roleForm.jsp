...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="office.id" value="${affiliation.value}" labelName="office.name" labelValue="${affiliation.label}"
		...
		<div class="control-group">
			<label class="control-label">门店设置:</label>
			<div class="controls">
				<input id="meidaHidden" value="${list }" type="hidden" >
				<c:forEach items="${storeList }" var="storeId" >
					<input class="required" type="checkbox" name="storeIds" value="${storeId.value }"/>${storeId.label }
				</c:forEach>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
