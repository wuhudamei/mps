		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					...
					phone: {remote: "${ctx}/bizprojectchangebill/bizProjectChangeBill/validatPhone?id=${user.id}",
						isPhone:true}
				},
				messages: {
					loginName: {remote: "用户登录名已存在"},
					confirmNewPassword: {equalTo: "输入与上面相同的密码"},
					phone: {remote: "电话号码已存在",isPhone:"电话号码格式错误"}
				},
...
<%-- 					title="部门" url="/sys/office/treeData?type=2" cssClass="required" notAllowSelectParent="true"/> --%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input id = "phone" path="phone" htmlEscape="false" maxlength="100" class="required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
