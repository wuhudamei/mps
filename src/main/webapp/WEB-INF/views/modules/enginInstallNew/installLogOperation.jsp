...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<%----%>
            <c:forEach items="${list}" var="statusLog">
                    <ul class="pt3 pl3 pb3 bg_f mb2 font0 bor clearfix">
                        <li class="mb12 clearfix">
                        ...
                        <li class="mb12 wid_per50 flo_left clearfix">
                            ...
                            <p class="font14 col_3 flow"><fmt:formatDate type="date" value="${enginInstallNew.realIntoDate }"/></p>
                        </li>
                        <li class="mb12 wid_per50 flo_left clearfix">
                            <span class="col_grey font14 flo_left spanRgt">实际完工日期：</span>
                            <p class="font14 col_3 flow"><fmt:formatDate type="date" value="${enginInstallNew.realCompleteDate }"/></p>
                        </li>
                    </ul>
            </c:forEach>
