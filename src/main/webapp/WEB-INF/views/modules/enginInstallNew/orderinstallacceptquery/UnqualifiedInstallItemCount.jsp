...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/bizorderinstallplan/orderinstallacceptquery/unqualifiedInstallItemCount">不合格安装项统计</a></li>
</ul>
<form:form id="searchForm" modelAttribute="bizOrderInstallPlan"
           action="${ctx}/bizorderinstallplan/orderinstallacceptquery/unqualifiedInstallItemCount"
