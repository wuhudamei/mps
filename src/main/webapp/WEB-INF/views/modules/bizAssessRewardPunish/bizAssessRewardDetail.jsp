				...
				if(data == null){
					...
					for(var i=0;i<data.length;i++){
						if('${bizAssessRewardPunish.assessRuleId}' == data[i].id){
							$("#bizAssessRuleDescribe").html(data[i].bizAssessRuleDescribe);
		            	}
					}
				}
			}
...
<body>
	<ul class="nav nav-tabs">
		<li><a
			href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/queryBizAssessReward">项目经理奖励列表</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="bizAssessRewardPunish"
		...
		<table>
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:select path="relatedBusinessIdInt"
								id="relatedBusinessIdInt" class="input-medium needClear" disabled="true" onchange="findOrderInfoById()">
							</form:select>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
            ...
            <tr>
              <td colspan="2">
                  <div class="control-group">
						<label class="control-label">当前已累计奖励金额：</label>
						<div class="controls">
							<input type="text" value="" id="totalAmount" readonly="readonly" />
						</div>
					</div>
              </td>
            </tr>
			...
			<tr>
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:select path="assessRuleTypeId" id="assessRuleTypeId"
								class="input-medium" disabled="true" onchange="findAssessRule()">
							</form:select>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				...
				<td>
					<div class="control-group">
						<label class="control-label">奖励日期：</label>
						<div class="controls">
			...
			<tr>
				<td colspan="2">
					<div class="control-group">
						...
						<div class="controls">
						    <input type="hidden" id="assessRuleId" value="${bizAssessRewardPunish.assessRuleId}" />
						    <textarea id="bizAssessRuleDescribe" readonly="readonly" class="input-xxlarge "></textarea>
							<%-- <form:select path="assessRuleId" id="assessRuleId"
								class="input-medium" disabled="true" cssStyle="width:500px;" onchange="findBizAssessRuleById()">
							</form:select> --%>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
			...
			<tr>
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="rewardPunishAmount" id="rewardPunishAmount"
								htmlEscape="false" class="input-medium required" readonly="true" oninput="checkNumber(this)"/>
							<span class="help-inline"><font color="red">*</font> </span>
						</div>
					</div>
				</td>
				...
				<td>
					<div class="control-group">
						<label class="control-label">奖励分数：</label>
						<div class="controls">
