...
<body>
	<ul class="nav nav-tabs">
		<li class="active">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#">项目经理扣款列表</a></li>
			</ul>
		<li><a
			href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/openBizAssessPunishForm">项目经理扣款添加</a>
		</li>
		</li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizAssessRewardPunish"
		...
		<ul class="ul-form">
			...
			<li><label>扣款日期：</label> <input name="startDate" id="startDate"
				...
				<tr>
					...
					<td><a href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/detail?id=${bizAssessRewardPunish.id}">详情</a> 
					    <c:if test="${bizAssessRewardPunish.rewardPunishStatus == 1}">
							<a href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/openBizAssessPunishForm?id=${bizAssessRewardPunish.id}">修改</a>
