        ...
        $(document).ready(function () {
            ...
            $("#inputForm").validate({
                ...
                messages: {
                    ...
                    rewardPunishTargetEmployeeId: "请选择罚款人员",
                },
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data != null) {
                        ...
                        var label = data.communityName + "-" + data.buildRoom + "-" + data.customerName
                        $("#s2id_relatedBusinessIdInt .select2-chosen").html(label);
                    }
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == null || data.length < 1) {
                        ...
                        row = ${status.index+1};
                        var html = "<tr>";
                        html += "<th><select name='assessRuleTypeIds' disabled='true' id='assessRuleTypeId" + row + "' class='input-xlarge required' onchange='findAssessRule(" + row + ");'>";
                        ...
                        html += "</select></th>";
                        html += "<th><select name='assessRuleIds' disabled='true' id='assessRuleId" + row + "' onchange='findBizAssessRuleById(" + row + ")' style='width:700px;' class='input-xlarge required'><option value=''>--请选择--</option></select></th>";
                        ...
                        html += "<th><input type='button' "+read+" name='${ruleType.detailRemarks}' id='detailRemarks" + row + "' value='查看'  onclick='addRemarks(this);'  class='input-medium required'/></th>";
                        html += "</tr>";
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == null || data.length < 1) {
                        ...
                        html += "<th><input class='btn btn-primary' type='button' value='完成' fild='1' onclick='accomOrUpdate(this," + row + ")'/>&nbsp;&nbsp;&nbsp;" +
        ...
        function onclickAbandonedReject(){
            ...
            if(date == ""){
                ...
                if($("#trid"+row).children().length>5){
                    ...
                    var html = "<th><input type='hidden' name='detailRemarks'   value='"+date+"'  oninput='checkNumber(this)' class='input-medium required'/></th>";
...
<ul class="nav nav-tabs">
    <li><a
            href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/queryBizAssessReward?isMonthInspection=1">项目经理巡检罚款列表</a>
    </li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="bizAssessRewardPunish"
    ...
    <table>
        <tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                            <form:select path="storeId"  disabled="true" id="storeId"
        ...
        <tr>
            <td colspan="2">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:select path="enginDepartId" disabled="true" id="enginDepartId"
        ...
        <tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="orderNumber" id="orderNumber" readonly="true"
            ...
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:select path="relatedBusinessIdInt" readonly="true"
                                     id="relatedBusinessIdInt" class="input-medium needClear"
                                     onchange="findOrderInfoById()" disabled="true">
                        </form:select>
                        <span class="help-inline"><font color="red">*</font> </span>
                    </div>
                </div>
        ...
        <tr>
            ...
            <td>
                <div class="control-group">
                    <label class="control-label">罚款人员：</label>
                    <div class="controls">
                        <form:select path="rewardPunishTargetEmployeeId" disabled="true" id="rewardPunishTargetEmployeeId"
        ...
        <tr>
            <td>
                <div class="control-group">
                    <label class="control-label">合计罚款金额：</label>
                    <div class="controls">
            ...
            <td>
                <div class="control-group">
                    <label class="control-label">合计罚款分数：</label>
                    <div class="controls">
        ...
        <tr>
            <td colspan="2">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:textarea  style='width: 520px'   path="generalRemarks" id="buildRoom" readonly="true"
                                    htmlEscape="false" class="input-medium required"/>
                    </div>
                </div>
            </td>
