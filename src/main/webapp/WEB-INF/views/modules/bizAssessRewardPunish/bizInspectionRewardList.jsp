...
<body>
	<ul class="nav nav-tabs">
		<li class="active">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#">项目经理巡检奖励列表</a></li>
			</ul>
		<li><a
			href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/openBizAssessRewardForm?isMonthInspection=1">项目经理巡检奖励添加</a>
		</li>
		</li>
	</ul>
				...
				<tr>
					...
					<td><a href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/detail?ids=${bizAssessRewardPunish.ids}">详情</a>
					    <c:if test="${bizAssessRewardPunish.rewardPunishStatus == 1}">
							<a href="${ctx}/bizAssessRewardPunish/bizAssessRewardPunish/openBizAssessRewardForm?ids=${bizAssessRewardPunish.ids}">修改</a>
