...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">结算确认交款查询</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="bizOrderFinanceCollection"
		action="${ctx}/bizOrderFinanceCollection/bizOrderFinanceCollection/queryBizOrderFinanceCollectionList"
		...
		<ul class="ul-form">
			...
			<li><label>交款确认时间：</label> <input name="beginCheckDate"
			...
			<li style="height: 90px">
				<c:forEach items="${fns:getDictList('collection_status')}"
					var="dict">
					<input type="checkbox" name="collectionStatusList" id="collectionStatusList"
						value="${dict.value}"
					 <c:if test="${fns:checkIsExits(bizOrderFinanceCollection.collectionStatusStrs,dict.value)}"> checked="checked"</c:if>
