...
<head>
    ...
    <title>投诉答复</title>
    <link rel="stylesheet" href="${ctxStatic}/mobile/modules/pqc/css/lib/mobiscroll.custom-2.16.1.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="${ctxStatic}/mobile/modules/pqc/css/bdstart/bdstart.css" />
...
<body>
    <div class="">
        ...
        <input name="workOrderCode" value="${map.workOrderCode}"  hidden="hidden">
        <input name="serviceProblemId" value="${map.serviceProblemId}"  hidden="hidden">
        ...
        <div style="background:rgba(0,0,0,.4);z-index:9;" class="g-mask undis" id="mask">
            <div class="alertMask">
                <div class="maskWrapper">
                    ...
                    <div class="font28 col_6 maskContent">投诉问题处理完毕</div>
    ...
    <script type="text/javascript" src="${ctxStatic}/mobile/modules/pqc/js/complaint/complaint.js"></script>
    ...
    <script type="text/javascript">
        ...
        $("#sureId1").click(function(){
        	$.ajax({
                url: baseAppUrl+"pqc/project-issue/savePqcDeal",
                type: "post",
                ...
                success:function(data){
                    if(data==1){
                    	//查询是否还有未处理的问题
                    	$.ajax({
                           url: baseAppUrl+"pqc/project-issue/selectCountNoDealByWorkOrderCode",
                           type: "post",
                           data:$("#workOrderCode").val(),
                           success:function(result){
                                if(result==0){
                                	var workOrderCode = $("#workOrderCode").val();
                                	var serviceProblemId = $("#serviceProblemId").val();
    								var status = '10';
   			                        $.post("${ctx}/ordercomplan/bizOrderComplaint/ajaxupdateScuStats",{workOrderCode:workOrderCode,serviceProblemId:serviceProblemId,status:status},function(data){
   										
   										if(data.code==1){
   											//同步状态成功，返回列表
   											window.location.href="${ctx}/app/pqc/project-issue/list.php";
   										}else{
