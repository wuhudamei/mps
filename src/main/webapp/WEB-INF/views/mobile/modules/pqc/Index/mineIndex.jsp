...
<body>
	...
	<div class="g_info">
		...
		<ul class="info_ul">
			...
			<li class="baogao"><a href="${ctx}/app/pqc/report/orderList">质检报告</a></li>
			<li class="yuejianRecord"><a href="${ctx}/app/pqc/apply-check-detail/pre-list.php">约检记录</a></li>
			<li class="yuejianRecord"><a href="${ctx}/app/pqc/apply-check-plan/preList.php">订单约检计划</a></li>
			<!-- <li class="yuejianRecord"><a href="javascript">约检记录</a></li> -->
			...
			<li class="order"><a href="${ctx}/app/pqc/orderReport/toOrderReportRecord">推荐记录</a></li>
			<li class="comment"><a href="${ctx}/app/inspector/method/methodOne">工艺工法</a></li>
			<li class="common-issue"><a href="${ctx}/app/pqc/question-list.php">常见问题</a></li>
