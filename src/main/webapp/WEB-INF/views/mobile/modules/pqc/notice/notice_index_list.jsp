...
<link rel="stylesheet" type="text/css"
	href="${ctxStatic}/mobile/modules/Worker/css/common.css" />
<link rel="stylesheet" type="text/css"
	href="${ctxStatic}/mobile/modules/Worker/css/info.css" />
<link rel="stylesheet" type="text/css"
	href="${ctxStatic}/mobile/modules/Worker/css/message2.css" />
...
<body>
	<div class="g-info">
		<div class="alls sec msg_sec g-message" style="margin-bottom: 300px;">
			...
			<nav class="msg_nav bg_f mar_btm2 font0">
				<a class="nav_a font30 col_6" href="${ctx}/app/pqc/message"><span>系统通知</span></a>
				<a class="nav_a font30 col_6" href="javascript:void(0)"><span
					class="active">公告</span></a>
			</nav>
			<!-- <section class="main"> -->
			<input id="pageNo" type="hidden" value="1" /> <input id="pageTotal"
				type="hidden" />
		...
		<footer>
			...
			<a class="footer_btn msg_btn active" href="javascript:void(0)">消息<div class="msg_countmine">${unreadMessageNum }</div>
			</a>
	...
	function loadList(){
		...
		$.post("${ctx}/app/pqc/notice/queryLoadNoticePageList",{pageNo:$("#pageNo").val(),pageSize:6,receiverEmployeeId:${inspectorId}},function(result){
			var content = "";
			for(var i=0;i<result.list.length;i++){
				...
				content = content + "<a href='${ctx}/app/pqc/notice/queryNoticePageListDetail?id="+result.list[i].id+"'><li class='noread pad_left45 pad_rgt3 border_btm pad_btm5'>" +alreadContent+"<p class='title font30 col_3 pad_top3'>"+
