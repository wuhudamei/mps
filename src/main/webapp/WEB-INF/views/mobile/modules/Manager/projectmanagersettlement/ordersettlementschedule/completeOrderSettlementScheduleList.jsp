            ...
            <div class="sec font0 border_top mar_btm24 pad_top3 flow clearfix">
                <ul class="pad_left3 date-line pad_btm3">
                    <!-- <li class="mb30 clearfix posA">
                        <i class="icon icon-time">icon</i>
                        <p class="bg-list col_6 font30 flow flex flex-between"><span class="col_blue">质检员确认验收约检节点</span><span class="font26">2016-08-12 18:30:35</span></p>
                        </p>
                    </li> -->
<%--                    <li class="mb30 clearfix posA">
                    ...
                    <li class="mb30 clearfix posA">
                        <i <c:if test="${orderSettlementSchedule.pmApplyCompleteDatetime != null}">class="icon icon-time"</c:if> 
                        <c:if test="${orderSettlementSchedule.pmApplyCompleteDatetime == null}">class="icon icon-time _undone"</c:if> >icon</i>
                        <p class="bg-list col_6 font30 flow flex flex-between">
                        <span <c:if test="${orderSettlementSchedule.pmApplyCompleteDatetime != null}">class="col_blue"</c:if> >项目经理申请竣工</span>
                        <span class="font26"><fmt:formatDate value="${orderSettlementSchedule.pmApplyCompleteDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                        </p>
                    </li>
                    <li class="mb30 clearfix posA">
                        ...
                        <p class="bg-list col_6 font30 flow flex flex-between">
                        <span <c:if test="${orderSettlementSchedule.settlementClerkPassDatetime != null}">class="col_blue"</c:if> >结算员审核通过竣工</span>
                        <span class="font26"><fmt:formatDate value="${orderSettlementSchedule.settlementClerkPassDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                        </p>
                    </li>
                    <li class="mb30 clearfix posA">
                        ...
                        <p class="bg-list col_6 font30 flow flex flex-between">
                        <span <c:if test="${orderSettlementSchedule.financeAffirmDatetime != null}">class="col_blue"</c:if> >财务确认尾款</span>
                        <span class="font26"><fmt:formatDate value="${orderSettlementSchedule.financeAffirmDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                        </p>
                    </li>
                    <li class="mb30 clearfix posA">
