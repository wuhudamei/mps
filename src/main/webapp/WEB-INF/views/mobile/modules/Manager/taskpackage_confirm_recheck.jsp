			...
			<section class="check_section padtop8">
					...
					<c:forEach items="${taskProcedureList}" var="taskProcedure"
						...
						<li class="project_list salary btm_border mar_top20 undis">
							<ul>
								...
								</span> <span class="pro_span font0"> <span class="col6 font28">工料费金额：</span>
				...
				<div class="box-bottom pad_btm2">
					...
					<c:if test="${checkTaskPack=='1'}">
						...
						<div class="lists font0 shadow">
							<span class="font28 col6"> <span class="col6">沙子水泥材料金额：</span>
								...
								<input style="width: 1.3rem;" class="days wid200 text_grey" type="text" id="sandAmount" readonly="true" name="sandCementAmount" value="${taskSettlement.sandCementAmount}" />元
					...
					<div class="lists font0 shadow">
						...
						<br />
						<span class="font28 col6"> <span class="col6">结算总金额：</span>
							<input class="days wid200 text_grey" type="text" readonly="true"
							id="settlementAmount" name="settlementAmount">元
						</span> 
						<br />
						<span class="font28 col6"> <span class="col6">工人组结算金额：</span>
							<input class="days wid200 text_grey" type="text" readonly="true"
							id="workerGroupSettleAmount" name="workerGroupSettleAmount">元
						</span> 
						<br />
						<span class="font28 col6"> <span class="col6">项目经理材料结算金额：</span>
							<input class="days wid200 text_grey" type="text" readonly="true"
