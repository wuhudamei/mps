...
<body>
	<div class="mar_btm300">
		<header>
			<a class="back_btn"  onclick="myhistory.back()" href="${ctx}/app/manager/method/task_query"></a>
...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">安全：安全服务</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.施工前未对工人进行安全教育及交底',
  		zgfs: '违：罚款',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：3分/200元', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.出现安全事故，项目经理未通知公司工程部，不及时将受伤人员送医，推诿拖延',
  		zgfs: '违：罚款',
  	...
  	},
  	{
  		title: '3.施工现场未配备消防设施。',
  		zgfs: '违：罚款',
  		bcfr: ['质检员（分数/金额）：5分/20元', '项目经理（分数/金额）：8分/50元', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '4.发现现场使用“热得快”“小太阳”。',
  		zgfs: '违：罚款',
  		bcfr: ['质检员（分数/金额）：3分/100元', '项目经理（分数/金额）：3分/50元', '施工工人（分数/金额）：3分/100元']
  	}];
