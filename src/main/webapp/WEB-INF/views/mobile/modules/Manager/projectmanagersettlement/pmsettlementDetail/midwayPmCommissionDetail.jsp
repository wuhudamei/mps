    ...
    <div class="wrap">
        ...
        <section class="pad_top88">
            <div class="item-tips">
                ...
                <p class="pad0">派单时项目经理星级：指的是派单员派订单给项目经理时，项目经理当时的星级。
                </p>
                <p class="pad0">提成总金额：指的是每户订单的项目经理提成总金额。
                </p>
                <p class="pad0">提成比例：指的是每户订单中期提成发放的比例。
                </p>
                <p class="pad0">中期提成实发金额：等于 提成总金额 * 提成比例。
                </p>
            </div>
            <div class="item-total align-right bg_f margin-tb25 font30">中期提成实发金额：<span class="font34 dark-red">+${commissionAmount} </span>元</div>
            <div class="sec font0 border_top border_btm mar_btm24 bg_f shadow clearfix">
                <ul class="pad_top3 pad_left3">
                    <li class="mb30 clearfix">
                        ...
                        ${fns:getDictLabel(bizPmStarCommissionCnfgSnap.isOldNew, 'biz_is_new_house','')}
                        </p>
                    </li>
                    <li class="mb30 clearfix">
                        <span class="col_grey font30 flo_left pl2em">派单时项目经理星级：</span>
                        <p class="font30 col_3 pad_rgt3 flow">
                        ${fns:getDictLabel(bizPmStarCommissionCnfgSnap.starLever, 'manager_star','')}
                        </p>
                    </li>
                    <li class="mb30 clearfix">
                    ...
                    <li class="mb30 clearfix">
                        ...
                        <p class="font30 col_3 pad_rgt3 flow">${bizPmStarCommissionCnfgSnap.commissionRateMidway * 100}%</p>
                    </li>
                    <li class="mb30 clearfix">
                        <span class="col_grey font30 flo_left pl2em">中期提成实发金额：</span>
