...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">强电工程：各管道间距</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.电线与暖气，热水，煤气管之间平行距离≥300mm，交叉距离≥100mm，并做隔热处理；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0元', '施工工人（分数/金额）：0元']
  	},
  	{
  		title: '2.电器开关，插座与燃气管间距≥500mm；',
  		dw: '',
  		zgfs: '违：返工重做',
