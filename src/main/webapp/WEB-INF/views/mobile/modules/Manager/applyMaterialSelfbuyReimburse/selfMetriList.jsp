...
<body>
	<div class="">
		...
		<section class="pad_top11" id="padTop11">
			...
			<div class="sec font0 border_top border_btm mar_btm24 bg_f clearfix">
				<ul class="pad_top3 pad_left3 bor_dotted">
					...
					<li class="mar_btm24 clearfix">
						...
						<p class="font28 col_blue pad_rgt3 flow">已派项目经理</p>
					</li>
				</ul>
				<div class="btn_wrapper clearfix">
					<a class="two_btn1" href="javascript:;">申请</a>
					<a class="two_btn2" href="javascript:;">申请记录</a>
				</div>
			</div> -->
		</section>
...
<script type="text/javascript">
	...
	function searchOrderList(){
		...
		var sectionObj=$("#padTop11");
        var html ='';
        html+='<div class="mar_btm14 font0 search-area"> <input class="search-box" type="text" placeholder=" 小区名称、客户姓名"> <a class="search-btn"  onclick="searchOrderList()" ></a> </div>';
        ...
        $.ajax({
            url: "${ctx}/app/manager/applyMaterialSelfbuyReimburse/material_selfbuy_reimburse_ajax_list",
            type: "post",
            data:param,
            success: function(data){
            	...
            	if(null!=data){
            		for(var v=0;v<data.length;v++){
    					...
    					html += '<li class="mar_btm24 clearfix">'+
		    						'<span class="col_grey font28 flo_left spanRgt">订 单 状 态 ：</span>'+
		    						'<p class="font28 col_blue pad_rgt3 flow">'+data[v].orderStatusDescription+'</p>'+
		    					'</li>'+
		    				'</ul>'+
		    				'<div class="btn_wrapper clearfix">'+
		    					'<a class="two_btn1" onclick="applyMaterial('+data[v].orderId+')">申请</a>'+
		    					'<a class="two_btn2" href="${ctx}/app/manager/applyMaterialSelfbuyReimburse/materialSelfbuyReimburseRecord?orderId='+data[v].orderId+'">申请记录</a>'+
		    				'</div>'+
		    			'</div>';
	...
	//自采材料报销申请
	function applyMaterial(orderId){
		 ...
		 $.ajax({
	            ...
	            success: function(data){
	            	if(null!=data && data == "0"){
	            		...
	            		window.location.href = "${ctx}/app/manager/applyMaterialSelfbuyReimburse/material_selfbuy_reimburse?orderId="+orderId;
