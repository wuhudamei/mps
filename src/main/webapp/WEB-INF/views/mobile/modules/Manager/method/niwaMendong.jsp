...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">泥瓦工程：门洞过梁</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.洞口≥600mm，必须浇筑过梁或采购成品过梁安装，严禁使用木梁；（拍照） ',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：8分/100元', '项目经理（分数/金额）：5分/50元', '施工工人（分数/金额）：8分/100元']
  	},
  	{
  		title: '2.浇筑过梁的厚度必须≥60mm，放置φ6mm以上钢筋；（拍照）',
  		dw: '',
  		zgfs: '违：返工重做',
