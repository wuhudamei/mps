...
<body>
	<div class="mar_btm300">
		<header>
			<a class="back_btn"  onclick="myhistory.back()" href="methodNiwa"></a>
			<h2 class="title">包排水管道</h2>
		</header><!-- /header -->
...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">泥瓦工程：包排水管道</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.可采用轻体砖砌筑，做降噪处理，降噪处理采用吸音棉，砌筑采用一顺一丁，相互咬合。抹灰前，与墙体结合部位必须挂钢丝网；（拍照）',
  		dw: '',
  		zgfs: '违：返工重做',
