...
<body>
	<div class="font0">
			...
			<div class="sec font0 bor_top_ddd bg_f clearfix">
				...
				<ul class="tableUl">
					<li class="clearfix">
						...
						<span class="col_6 font30 fl">+8000.0元</span>
					</li>
					<li class="clearfix">
						<span class="col_6 font30 fl">竣工质检罚款</span>
						<span class="col_6 font30 fl">-100.0元</span>
					</li> 
					<li class="clearfix">
					...
					<li class="clearfix">
						...
						<span style="padding-left:0;" class="col_3 font30 fl">2000 - 1500 = +500.0</span>
					</li>
				</ul>
				<p class="totalP">
		...
		<div class="pt76 pl50 pr50">
			<a class="btnBlueOne" href="javascript:;">同意</a>
			<a class="btnBlueTwo" href="javascript:;">拒绝</a>
		</div>
