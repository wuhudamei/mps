...
<body>
	<div class="g-materi">
		...
		<footer>
			...
			<a href="javascript:void(0)" id="flatopenDoor"><span class="btn font28">提交</span></a>
		</footer>
		<!-- 照片弹出层 -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			//绑定onclick事件
			$("#flatopenDoor").bind('click',flatSubmit);
		});
		...
		$(function(){
			...
			var flatopenList = "${flatopenList}";
			var sub = flatopenList.toString().substr(flatopenList.indexOf("[")+1,flatopenList.indexOf("]")-1).split(",");
			...
			function add_li(id){
				...
				$("#border_btm"+id).append('<li class="line_hgt7 clearfix"><span class="font28 col_6 flo_left">内外开向：</span><p class="p_right"><span class="radio_span marrgt1"><input type="radio" id="a3' + id +'" name="inOutOpen'+ id +'" value="0"><label class="font26 col_6 mar_rgt10 checked" data-name="side' + id +'" for="a3' + id +'">内　　开</label></span><span class="radio_span"><input type="radio" id="b3' + id +'" name="inOutOpen'+ id +'" value="1"><label class="font26 col_6 mar_rgt10" data-name="side' + id +'" for="b3' + id +'">外　　开</label></span></p></li>') 
				$("#border_btm"+id).append('<li class="line_hgt7 clearfix"><span class="font28 col_6 flo_left">锁开方向：</span><p class="p_right"><span class="radio_span marrgt1"><input type="radio" id="a2' + id +'" name="openDirection'+ id +'" value="0"><label class="font26 col_6 mar_rgt10 checked" data-name="lock' + id +'" for="a2' + id +'">左锁右开</label></span><span class="radio_span"><input type="radio" id="b2' + id +'" name="openDirection'+ id +'" value="1"><label class="font26 col_6 mar_rgt10" data-name="lock' + id +'" for="b2' + id +'">右锁左开</label></span></p></li>')
				$("#border_btm"+id).append('<li class="line_hgt7 font0 clearfix"><span class="font28 col_6">宽　　度：</span><input id="width'+id+'" name="width" class="font28 col_6 wid_314 blue_border pad_top1 pad_btm1 mar_rgt2" type="text" maxlength="4" onkeyup="validationData('+id+',this);"><span class="font28 col_6">mm</span></li>') 
				$("#border_btm"+id).append('<li class="line_hgt7 font0 clearfix"><span class="font28 col_6">高　　度：</span><input id="height'+id+'" name="height" class="font28 col_6 wid_314 blue_border pad_top1 pad_btm1 mar_rgt2" type="text" maxlength="4" onkeyup="validationData('+id+',this);"><span class="font28 col_6">mm</span></li>') 
				$("#border_btm"+id).append('<li class="line_hgt7 font0 clearfix"><span class="font28 col_6">厚　　度：</span><input id="thickness'+id+'" name="thickness" class="font28 col_6 wid_314 blue_border pad_top1 pad_btm1 mar_rgt2" type="text" maxlength="4" onkeyup="validationData('+id+',this);"><span class="font28 col_6">mm</span></li>') 
				$(".font0").append('</ul>')
		...
		function flatSubmit(){
			...
			/**禁用按钮**/
			$("#flatopenDoor").css("color","#CCC");
			$("#flatopenDoor").unbind("click");
			var options ={
				url : "${ctx}/app/manager/flatSubmitData",
				type: "post",
				success : function(data){
					if(data == 0){
					  ...
					  if(data == 2){
						  globalUtil.fn.alert("提交平拉门数据失败...",2.0);
					  }
					  if(data == 3){
