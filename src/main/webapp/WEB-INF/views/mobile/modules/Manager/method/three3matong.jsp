...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">给水工程：马桶安装</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.马桶底座与地面接触应保持水平度，安装后，底座与地面周边必须用玻璃胶收口，打胶后24小时内不得使用；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.安装完毕后调试水位，做冲水试验，检查是否通畅，是否有渗漏现象，无误后做成品保护；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
