...
<body>
    <div class="wrap">
        <header>
            ...
            <h2 class="title">竣工质检罚款明细</h2>
        </header>
        <!-- /header -->
        <section class="pad_top88">
            <div class="item-total align-right bg_f margin-tb25 font30">竣工质检罚款合计：<span class="font34 dark-red">${managerPenalty} </span>元</div>
               ...
               <div class="sec font0 border_top border_btm mar_btm24 bg_f shadow clearfix">
                <ul class="pad_top3 pad_left3">
                    <li class="mb30 clearfix">
                        ...
                        <p class="font30 col_3 pad_rgt3 flow col_blue">${pmPunish.qcBillCheckKindName}</p>
                    </li>
                    <li class="mb30 clearfix">
                        <span class="col_grey font30 flo_left pl2em">检 查 项 ：</span>
                        <p class="font30 col_3 pad_rgt3 flow">${pmPunish.qcBillCheckItemName}
                        </p>
                    </li>
                    <li class="mb30 clearfix">
                        <span class="col_grey font30 flo_left">罚款金额：</span>
                        <p class="font30 col_3 pad_rgt3 flow">${pmPunish.money}元</p>
                    </li>
                    <li class="mb30 clearfix">
                        <span class="col_grey font30 flo_left pl2em">提交时间：</span>
                        <p class="font30 col_3 pad_rgt3 flow"><fmt:formatDate value="${pmPunish.actualCheckDate}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
                    </li>
                </ul>
            </div>
            </c:forEach>
