...
<body>
    <div class="wrap">
        ...
        <section class="pad_top88">
            ...
            <div class="item-total align-right bg_f margin-tb25 font30">竣工巡检奖励合计金额：：<span class="font34 dark-red">+${pmRewardAmount} </span>元</div>
                    ...
                    <ul class="pad_top3 pad_left3 pad_rgt2">
                        ...
                        <li class="mb30 clearfix">
                            <p class="font30 col_3 pad_rgt3 flow">
                                <span class="col_grey font30 flo_left">${pmReward.assessRuleDescribe}</span>
                            </p>
                        </li>
                        <li class="mb30 clearfix">
                            <p class="font30 col_3 pad_rgt3 flow"><span class="col_grey font30 flo_left">奖励金额：</span>+${pmReward.rewardPunishAmount}元</p>
                        </li>
                        <li class="mb30 clearfix">
                            <p class="font30 col_3 pad_rgt3 flow"><span class="col_grey font30 flo_left">录入时间：</span><fmt:formatDate value="${pmReward.rewardPunishDatetime}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
                        </li>


                        <li class="mb30 clearfix">
                            <p class="font30 col_3 pad_rgt3 flow"><span class="col_grey font30 flo_left">备注：</span>${pmReward.detailRemarks}</p>
                        </li>
                    </ul>
                </div>
            </c:forEach>
