...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">泥瓦工程：踢脚线铺贴</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.施工上游：地面砖铺贴完成；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.原墙面有抹灰或腻子，必须铲除腻子层，搓毛处理，方可贴砖；（拍照）',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '3. 踢脚线上口顺直，高低差≤2mm，瓷砖与瓷砖≤0.5mm，拼角无崩边，无空鼓；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
