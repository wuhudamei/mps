...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctxStatic}/mobile/modules/Manager/css/message2.css"/>
		...
		<div class="alls sec home_sec">
			...
			<div class="sec task_sec">
				<nav class="of_nav font0 clearfix">
					...
					<a class="of_btn" href="${ctx}/app/manager/newEnginInstallController/installListNew?index=1&apply=1">
				...
				<ul class="home_ul font0">
					...
					<%-- <li class="hgt_88 forward"><a class="font28 col_3 list_a" href="${ctx}/app/manager/progressWarning/list">预警监控</a></li> --%>
					...
					<li class="hgt_88 problem"><a class="font28 col_3 list_a" href="${ctx}/app/manager/problem/siteDesign/menu">问题上报</a></li>
					...
					<li class="hgt_88 complain"><a class="font28 col_3 list_a" href="${ctx}/app/manager/project-issue/list.php">工程投诉</a></li>
					<%-- <li class="hgt_88 complain"><a class="font28 col_3 list_a" href="${ctx}/app/manager/delaysheet/list">延期订单申请</a></li>
					<li class="hgt_88 complain"><a class="font28 col_3 list_a" href="${ctx}/app/manager/delaysheet/list2">延期订单申请2</a></li> --%>
			 		<li class="hgt_88 complain"><a class="font28 col_3 list_a" href="${ctx}/app/manager/delaysheet/list3">延期订单申请</a></li>
			 		<div style="padding-top:300px;"></div>
				</ul>
			</div>
		</div>
		<footer>
			<a class="footer_btn home_btn active" href="javascript:void(0)">首页</a>
