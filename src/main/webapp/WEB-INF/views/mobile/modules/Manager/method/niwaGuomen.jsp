...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">泥瓦工程：过门石铺贴</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.施工上游：有防水要求区域过门石必须防水完工，蓄水试验完成；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.过门石必须为公司确定花纹，材质。与地面砖拼接处无高低差；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
