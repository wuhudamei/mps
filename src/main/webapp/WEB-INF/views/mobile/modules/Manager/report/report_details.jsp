...
<body>
	<div class="g-task_list">
		<header>
			<a class="back_btn" href="${ctx}/app/manager/report/reportList?orderId=${reportCheckDetails.orderId}" onclick="myhistory.back()"></a>
		...
		<section class="task_list confirm">
			...
			<div class="pic_div bor_top shadow font0">
				...
				<c:if test="${count eq 0 }">
					<a class="see_no_btn">查看照片</a>
				</c:if>
				<c:if test="${count ne 0 }">
					<a class="see_btn" href="${ctx}/app/manager/report/reportPic?qcBillId=${reportCheckDetails.id}">查看照片</a>
				</c:if>
			</div>
			<div class="design shadow">
				<c:forEach items="${itemDetails }" var="itemDetails" varStatus="status">
					<div class="bor_top num">
							<div class="item bor_top hgt86 font0 relative">
								<span class="font28 col3 pad_left3">${itemDetails.qcCheckItemName }</span>
