...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">泥瓦工程：水泥砂浆地面找平</a>
...
<script>
	$(function(){
  	...
  	{
  		title: '2.地面水泥找平采用1:3水泥砂浆，表面平整≤3mm，密实不起沙。楼下住户己经装修完成的必须采用干浆法进行地面找平；基层做地固或扫浆处理。',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：5分/100元', '项目经理（分数/金额）：3分/50元', '施工工人（分数/金额）：5分/100元']
  	},
  	{
  		title: '3.2米检测尺验收平整度≤3mm，表面光滑，无空鼓，无起砂，烧坏；',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
