...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">给水工程：压力试验</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1. 试验压力为0.6Mpa，打压2小时无渗漏，压力下降≤10%为合格；（拍照）',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：8分/100元', '项目经理（分数/金额）：5分/50元', '施工工人（分数/金额）：8分/100元']
  	},
  	{
  		title: '2.客户签字与认可，客户无法到现场，拍照留证，发给客户；',
  		dw: '',
  		zgfs: '违：罚款',
  		bcfr: ['质检员（分数/金额）：3分/100元', '项目经理（分数/金额）：2分/100元', '施工工人（分数/金额）：0']
  	}];
