...
<body>
    <div class="wrap">
        ...
        <section class="pad_top88">
            <div class="item-total align-right bg_f margin-tb25 font30">中期扣款合计： <span class="font34 dark-red">-${pmPunishAmount} </span>元</div>
                ...
                <c:forEach items="${list}" var="pmPunish">
                  <ul class="pad_left3 date-line pad_btm3">
                    ...
                    <li class="pad_btm2 border_btm clearfix">
                        ...
                        <p class="font30 col_3 pad_rgt3 flow"><fmt:formatDate value="${pmPunish.createDate}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
                    </li>
                </ul>
                </c:forEach>
            </div>
