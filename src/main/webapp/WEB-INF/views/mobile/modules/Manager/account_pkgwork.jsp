		...
		<div class="accessories sand_And_water">
			...
			<h3 class="title_content"><i class="blue_line"></i><p>结算单基本信息</p></h3>
				<ul class="get_price">
					...
					<p>人工费预算总金额：<span class="col_red">${budgetTotalMoney}元</span></p>
					<p>人工费结算总金额：<span class="col_red">${settleTotalMoney}元</span></p>
					<span class="look_cont"><a href="${ctx}/app/manager/accountDetails?id=${workTaskPackage.id }&settleStyle=2">查看详情 <i class="icon_arrowRight"></i></a></span>
					</li>
					<li class="SeePhotos_cont">
						<p class="SeePhotos"><a href="${ctx}/app/manager/seePhoto?id=${workTaskPackage.id }&settleStyle=2">查看完工照片</a></p>
					</li>
				</ul>
			</section>
				<section> 
			...
			<section class="retention">
				...
				<table>
					...
					<tbody>
						<tr><td>人工费结算金额</td><td>${settleTotalMoney}元</td></tr>
