...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctxStatic}/mobile/modules/Manager/css/change_details.css"/>
	<link rel="stylesheet" type="text/css" href="${ctxStatic}/mobile/modules/Manager/css/quesDone.css" />
<style>
		
		#toPicDetails{
			width:3.2rem;line-height:.66rem;background:#0780ec;font-size:.28rem;color:#fff;border:none;border-radius:.35rem;float:right;
	...
	<div class="g-review">
		...
		<section class="pad_top10 mar_btm50 font0">
			<div class="mar_left3 mar_rgt3 mar_top1">
				<span class="font28 co_3">变更原因<em class="font24 co_6"></em>：</span>
				...
				<textarea class="reason_area"readonly>${bill.changeReason }</textarea>
			</div>
			<section class="after">
