...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">油工工程：壁纸铺贴</a>
...
<script>
	$(function(){
		var noticeList = [
  	{
  		title: '1.壁纸铺贴前，必须检查墙体的平整度，阴阳角顺直度，打磨标准，方可涂刷基膜；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.涂刷基膜必须均匀，无凹凸感，待干后方可铺贴壁纸；',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：1分/20元', '项目经理（分数/金额）：2分/50元', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '3.墙面阴阳角进行壁纸铺贴时，严禁在墙柱转角阳角接口，须将阳角的壁纸进行整张铺贴转弯；',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：1分/20元', '项目经理（分数/金额）：2分/50元', '施工工人（分数/金额）：0']
  	}];
