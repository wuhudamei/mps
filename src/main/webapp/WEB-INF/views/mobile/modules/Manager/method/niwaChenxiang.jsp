...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">泥瓦工程：沉箱回填</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.施工上游：必须完成防水作业，并干燥，完成蓄水试验，客户签字；完成排水系统改造完成。 ',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.回填材料可用陶粒，煤渣，严禁使用建筑垃圾回填；（拍照）',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：3分/300元', '项目经理（分数/金额）：2分/200元', '施工工人（分数/金额）：3分/300元']
  	},
  	{
  		title: '3.回填高度低于±0标高100mm左右，然后做50mm厚的水泥砂浆找平；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
