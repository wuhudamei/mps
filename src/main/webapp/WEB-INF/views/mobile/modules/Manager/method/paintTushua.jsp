...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">油工工程：涂刷墙漆一底两面</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.涂刷墙漆为一底两面，墙漆兑水参照产品说明标准，兑水不得超过说明标准',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  	...
  	{
  		title: '3.全部主材安装完成后，对磕碰处进行修补；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '4.两种不同颜色的涂刷分色均匀，顺直，细致，严禁混色；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '5.施工剩余材料清理完毕，集中堆放，室内垃圾全部清理；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
