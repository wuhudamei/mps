	...
	<div class="">
		...
		<section class="font0 pad_top10">
			...
			<ul class="sec clearfix">
				<c:forEach items="${taokouList}" var="taokouList" varStatus="status">
				<li class="mar_top2 pad_left2 pad_rgt2 flo_left">
					<p class="pos font30 col_3">${fns:getDictLabel(taokouList.position, 'recheck_taokou_position', '')}</p>
					<ul class="bars bg_f pad_left2 pad_top2 pad_btm2 shadow">
						<li>
							<span class="font28 col_6">包套方式：</span>
							<%-- <c:if test="${taokouList.packageCover =='0'}"><span class="font28 col_3">单　　包</span></c:if>
							<c:if test="${taokouList.packageCover =='1'}"><span class="font28 col_3">双　　包</span></c:if> --%>
							<span class="font28 col_3">${fns:getDictLabel(taokouList.packageCover, 'recheck_taokou_packagecover', '')}</span>
						</li>
						<li>
							<span class="font28 col_6">洞口宽度：</span>
							<span class="font28 col_3"><fmt:formatNumber value="${taokouList.holeWidth }" pattern="#"/>mm</span>
						</li>
						<li>
							<span class="font28 col_6">洞口高度：</span>
							<span class="font28 col_3"><fmt:formatNumber value="${taokouList.holeHeight }" pattern="#"/>mm</span>
						</li>
						<li>
							<span class="font28 col_6">洞口厚度：</span>
							<span class="font28 col_3"><fmt:formatNumber value="${taokouList.holeThickness }" pattern="#"/>mm</span>
						</li>
					</ul>
				</li>
				</c:forEach>
