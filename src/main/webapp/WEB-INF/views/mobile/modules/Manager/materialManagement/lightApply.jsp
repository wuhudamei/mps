...
<script type="text/javascript" charset="utf-8">
    $(function () {
        ...
        $.ajax({
            url: "${ctx}/app/manager/getShippingFee?bizMaterialsStandardType=2",
            type: "get",
...
<div class="show_sec">
    <header>
        <a class="back_btn" href="${ctx}/app/manager/applyLightMaterial/lightMaterialList"
           onclick="myhistory.back()"></a>
        <h2 class="title">提交灯具和五金</h2>
    </header><!-- /header -->

    <section id="toptop" class="pad_top88">
        <ul class="font0">
            <form id="form" action="${ctx}/app/manager/applyLightMaterial/saveLightBill" method="post">
                ...
                <c:forEach items="${standardlist }" var="standard">
                    <li class="item bg_f pad_left3 pad_top24 pad_btm36 mar_top24 relative">
                        ...
                        <p class="font30 col_3 line_hgt16 mar_btm50">
                            【${standard.materialsType }】${standard.materialsName }</p>
                        <p class="font28 col_6"><span
                                class="col_red3 price1">${standard.materialsPrice }</span>/${standard.materialsUnit }
                        </p>
                        <div id="numbox" class="clearfix shopcount shopcountLgt">
                            <a class="reduce"
                               onclick="setTotal(this,2)">-</a>
                            <input type="number" id="num" name="number" class="shopNum font28" type="number" value=0
                                   name="count"
                                   onchange="setTotal(this,3,${standard.maxReceiveNumber},${standard.applyNumberTotal },${standard.receiveNumberTotal })"
    ...
    <footer>
        ...
        <a class="subBtn" href="javascript:void(0)" onclick="cart()">提交灯具和五金</a>
    </footer>
    <div class="alertMask undis" id="applyForRecord">
        <div class="maskWrapper">
            ...
            <div class="maskBtns clearfix twoBtns">
                <a class="maskBtnOne font33 col_fdfcfa"
                   href="${ctx}/app/manager/applyLightMaterial/detail?id=${billId}&&orderId=${orderId}">确定</a>
            </div>
        </div>
    </div>
