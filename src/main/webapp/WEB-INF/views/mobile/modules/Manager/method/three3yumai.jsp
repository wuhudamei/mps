...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">给水工程：管道预埋</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.离出水口预留300mm不予敷设水泥砂浆，为泥瓦工铺贴瓷砖时，便于调整出水口与墙面平整；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.水路隐蔽预埋工程安装牢固，墙面预埋部分不得高于基层表面；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
