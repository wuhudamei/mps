...
<body>
    <div class="wrap">
            ...
            <div class="sec pl30 pr30 font0 bg_f clearfix">
                <ul class="pad_top3">
                    <li class="mb30 rele clearfix">
                        ...
                        <p class="font30 col_3 flow">${orderInstall.installItemName }</p>
                    </li>
                    <li class="mb30 clearfix">
                        <span class="col_grey font30 fl">申请复尺计划日期：</span>
                        <p class="font30 col_3 flow"><fmt:formatDate value="${orderInstall.allowApplyChecksizeDate}" pattern="yyyy-MM-dd"/></p>
                    </li>
                    <li class="mb30 rele clearfix">
        ...
        <form id="jvForm" action="" method="post" enctype="multipart/form-data">
        	...
        	<input type="text" hidden="hidden" name="orderInstallItemId" value="${orderInstall.orderInstallItemId}">
    ...
    <div class="maskWrapper" id="alertAlertThree">
        ...
        <div class="maskBtns">
            <button class="maskBtnOne" type="button" onclick="history.go(-1)">确 定</button>
        </div>
    </div>
    <!-- /.maskWrapper -->
    ...
    <script>
    	...
    	var id = '${orderInstall.orderInstallItemId}';
		...
		function sure2(){
			...
			//上报提交表单
			var options ={
					url : "${ctx}/app/manager/checksize/save_install_apply_checksize_advance_apply_ajax",
					type: "post",
					success : function(data){
						...
						if(null!=data && data=="0"){
							...
							$("#alertRemark").text("每个主材复尺项【提前申请】只能申请一次");
		        			$("#alertMask").addClass('_in');
					        $("#alertAlert").addClass('_in');
						}else if(data=="4"){
							...
							$("#alertRemark").text("主材复尺项【提前申请】申请失败");
		        			$("#alertMask").addClass('_in');
					        $("#alertAlert").addClass('_in');
						}
