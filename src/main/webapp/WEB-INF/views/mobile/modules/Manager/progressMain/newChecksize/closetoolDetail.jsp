	...
	<div class="">
		...
		<section class="font0 pad_top10">
			...
			<ul class="sec clearfix">
				<c:forEach items="${toiletList}" var="toiletList" varStatus="status">
				<li class="mar_top2 pad_left2 pad_rgt2 flo_left">
					<p class="pos font30 col_3">${fns:getDictLabel(toiletList.position, 'recheck_closetool_position', '')}</p>
					<ul class="bars bg_f pad_left2 pad_top2 pad_btm2 shadow">
						...
						<li>
							...
							<span class="font28 col_3">${curtainList.poleLength }mm</span>
						</li> --%>
						<li>
							<span class="font28 col_6">马桶孔距：</span>
							<span class="font28 col_3"><fmt:formatNumber value="${toiletList.closestoolHoleSize }" pattern="#"/>mm</span>
						</li>
					</ul>
				</li>
				</c:forEach>
