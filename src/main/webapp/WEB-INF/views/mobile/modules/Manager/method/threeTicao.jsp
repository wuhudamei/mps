...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">强电工程：剔槽</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.剔槽要求横平竖直，严禁斜开槽，严禁剔≥300mm横槽。',
  		dw: '户',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：3分/100元', '项目经理（分数/金额）：2分/50元', '施工工人（分数/金额）：3分/100元']
  	},
  	{
  		title: '2.严禁切断钢筋，按照物业要求施工；如物业扣费由当事人承担费用，所扣费用项目经理承担30%，施工工人承担70%。',
  		dw: '户',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：10分/150元', '项目经理（分数/金额）：10分/100元', '施工工人（分数/金额）：10分/150元']
  	},
  	{
  		title: '3.剔槽顺序：槽两侧弹线——沿线切割——剔槽，严禁直接剔槽（拍照）',
  		dw: '户',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：3分/100元', '项目经理（分数/金额）：2分/50元', '施工工人（分数/金额）：3分/100元']
  	},
  	{
  		title: '4.剔槽深度为：线管φ+12mm，保证敷设厚度，避免开裂；',
  		dw: '户',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '5.厨房卫生间等有防水要求区域，线管开槽必须高于地面完成面300mm以上；',
  		dw: '户',
  		zgfs: '违：返工重做',
