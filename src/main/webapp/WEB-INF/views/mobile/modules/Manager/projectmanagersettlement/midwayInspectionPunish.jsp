...
<body>
    <div class="wrap">
        ...
        <section class="pad_top88">
            ...
            <div class="item-total align-right bg_f margin-tb25 font30">中期巡检罚款合计金额：：<span class="font34 dark-red">-${pmPunishAmount}  </span>元</div>
                ...
                <ul class="pad_top3 pad_left3 pad_rgt2">
                    ...
                    <li class="mb30 clearfix">
                        <p class="font30 col_3 pad_rgt3 flow">
                            <span class="col_grey font30 flo_left">${pmPunish.assessRuleDescribe}</span>
                        </p>
                    </li>
                    <li class="mb30 clearfix">
