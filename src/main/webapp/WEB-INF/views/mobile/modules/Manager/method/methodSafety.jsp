...
<body>
	<div class="mar_btm300">
		...
		<p class="pad_top88 bg_f font30 col_blue pad_left3 hgt76 shadow">安全篇</p>
		<p class="tit-p">一、安全篇</p>
		<ul class="bg_f">
			<a class="two" href="${ctx}/app/manager/method/threeAnquan"><li class="list-text">安全篇</li></a>
		</ul>
	</div>
</body>
