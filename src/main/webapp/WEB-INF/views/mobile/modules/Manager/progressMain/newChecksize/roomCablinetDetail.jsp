	...
	<div class="">
		...
		<section class="font0 pad_top10">
			...
			<ul class="sec clearfix">
				<c:forEach items="${cablinetList}" var="cablinetList" varStatus="status">
				<li class="mar_top2 pad_left2 pad_rgt2 flo_left">
					<p class="pos font30 col_3">${fns:getDictLabel(cablinetList.position, 'recheck_roomcabinet_position', '')}</p>
					<ul class="bars bg_f pad_left2 pad_top2 pad_btm2 shadow">
						<%-- <li>
							<span class="font28 col_6">窗帘杆类型：</span>
							<c:if test="${cablinetList.poleType =='0'}"><span class="font28 col_3">罗马杆</span></c:if>
							<c:if test="${cablinetList.poleType =='1'}"><span class="font28 col_3">滑道</span></c:if>
						</li>
						<li>
							<span class="font28 col_6">窗帘杆长：</span>
							<span class="font28 col_3">${cablinetList.poleLength }mm</span>
						</li> --%>
						<li>
							<span class="font28 col_6">浴室柜型号：</span>
							<span class="font28 col_3">${cablinetList.bathroomCabinetModel }</span>
						</li>
					</ul>
				</li>
				</c:forEach>
