...
<body>
	<div class="font0">
		<header>
			<a class="back_btn" href="${ctx}/app/manager/orderReport/toOrderReportManage"></a>
...
function submit(){
	...
	//校验通过
        $.ajax({
            url : "${ctx}/app/manager/orderReport/orderReportSave",
            type : "post",
            ...
            success : function(data) {
                ...
                setTimeout("window.location.href='${ctx}/app/manager/orderReport/toOrderReportRecord'",2000)
...
function check_illegal(num){
    ...
    case 2 :
        ...
        if($("#customerPhoneId").val().trim().length!=11 || isNaN(($("#customerPhoneId").val()))||$("#customerPhoneId").val().trim().length<1){
            ...
            $.ajax({
                url : "${ctx}/app/manager/orderReport/checkCustomerPhone?customerPhone=" + $("#customerPhoneId").val(),
                type : "post",
                success : function(data) {
                    if (data == "0") {
