...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">强电工程：交底定位放线</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.普通开关和插座高度图纸有标注的按图施工，图纸无标的按开关距成型地面1300mm，插座距成型地面300mm—350mm，热水器，洗衣机的插座必须高于出水口150mm；（利用原底盒不按此数据）',
  		dw: '处',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.特殊开关、插座高度须符合设计要求，符合设施、设备使用要求；',
  		dw: '处',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '3.安装顶灯位置按设计要求，无设计要求为房间正中心；注：房间顶面拉对角线；',
  		dw: '处',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	}];
