		...
		<form id="submitForm">
			...
			<section class="check_section padtop8">
				...
				<ul class="lists shadow">
					...
					<li class="line_hgt6 clearfix"><span class="span_left">任务包状态：</span>
				...
				<div class="box-bottom">
					...
					<ul class="lists shadow">
						...
						<li class="line_hgt6 clearfix"><span class="span_left">公司扣款：</span>
							<p class="p_right">
						  ...
						  -${taskSettlement.companyDeductAmount}元
								...
								<input type="hidden" id="companyDeductAmount"
									...
									value="${taskSettlement.companyDeductAmount}" />
							</p></li>
						<c:if test="${taskSettlement.companyDeductAmount != null}">
							<li class="line_hgt6 clearfix"><span class="span_left">公司扣款原因：</span>
								<p class="p_right" style="overflow: hidden;">
									${taskSettlement.companyDeductReason}</p></li>
						</c:if>
					</ul>
				</div>
							...
							<ul>
								...
								<li class="line_hgt6 clearfix"><span class="pro_span font0">
										...
										value="${taskProcedure.procedureName}" />
											...
											工料费金额：</span> <span class="col3 font28"
										id="laborAuxiliaryMaterialsSettleAmount${status.index}">${taskProcedure.laborAuxiliaryMaterialsSettleAmount}元</span>
										<input type="hidden"
										id="laborAuxiliaryMaterialsSettleAmountPrice${status.index}"
				...
				<div class="box-bottom mar_top100 pad_btm2">
					...
					<div class="lists font0 shadow">
						<span class="font28 col6"> <span class="col6">辅料金额：</span>
							<input type="hidden"
							id="auxiliaryMaterialsDeductAmountSupplierPrice"
							name="auxiliaryMaterialsDeductAmountSupplierPrice" /> <input
							type="hidden" id="auxiliaryMaterialsDeductAmountWangzhenPrice"
							name="auxiliaryMaterialsDeductAmountWangzhenPrice" /> <input
							class="days wid200 text_grey" type="text" readonly="true"
					...
					<c:if test="${checkTaskPack=='1'}">
						...
						<div class="lists font0 shadow">
							<span class="font28 col6"> <span class="col6">沙子水泥材料金额：</span>
								<input type="hidden" id="sandCementDeductAmountSupplierPrice"
								name="sandCementDeductAmountSupplierPrice" /> <input
								type="hidden" id="sandCementDeductAmountWangzhenPrice"
								name="sandCementDeductAmountWangzhenPrice" /> <input
								style="width: 1.3rem;" class="days wid200 text_grey" type="text"
								readonly="true" id="sandAmount" name="sandCementAmount"
					...
					<div class="lists font0 shadow">
						<span class="font28 col6"> <span class="col6">结算方式：${fns:getDictLabel(orderTaskpackageVo.settleStyle, 'settle_style', '')}</span>
							<input type="hidden" id="settleStyle" name="settleStyle"
							value="${orderTaskpackageVo.settleStyle}" />
						</span> <br /> <span class="font28 col6"> <span class="col6">结算总金额：</span>
							<input class="days wid200 text_grey" type="text" readonly="true"
							id="settlementAmount" name="settlementAmount">元
						</span> <br /> <span class="font28 col6"> <span class="col6">工人组结算金额：</span>
							<input class="days wid200 text_grey" type="text" readonly="true"
							id="workerGroupSettleAmount" name="workerGroupSettleAmount">元
						</span> <br /> <span class="font28 col6"> <span class="col6">项目经理材料结算金额：</span>
							<input class="days wid200 text_grey" type="text" readonly="true"
							id="pmMaterialsSettleAmount" name="pmMaterialsSettleAmount">元
						</span>
			...
			<section class="g-auxiliary_choose undis" id="sandModel">
				...
				<footer>
					<div>
						...
						<input type="hidden" id="sandSupplierTotal" /> <input
							type="hidden" id="sandWangzhenTotal" />
						<p class="goods">
			...
			<section class="g-auxiliary_choose undis" id="auxiliaryModel">
				...
				<footer>
					<div>
						...
						<input type="hidden" id="auxiliarySupplierTotal" /> <input
							type="hidden" id="auxiliaryWangzhenTotal" />
						<p class="goods">
