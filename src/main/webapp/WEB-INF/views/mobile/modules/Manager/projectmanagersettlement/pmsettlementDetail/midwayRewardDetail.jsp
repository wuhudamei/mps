				...
				<c:forEach items="${list}" var="pmReward">
					<ul class="pad_left3 date-line pad_btm3">
						...
						<li class="pad_btm2 border_btm clearfix"><span
							...
							<p class="font30 col_3 pad_rgt3 flow"><fmt:formatDate value="${pmReward.createDate}" pattern="yyyy-MM-dd HH:mm:ss" /></p></li>
					</ul>
				</c:forEach>
			</div>
		</section>
