	...
	<div class="g-info">
		<div class="alls sec msg_sec g-message">
			...
			<nav class="msg_nav bg_f mar_btm2 font0">
				...
				<a class="nav_a font30 col_6" href="${ctx}/app/manager/queryNoticePageList"><span>公告</span></a>
			</nav>
				<ul class="list bg_f font0">
					<c:forEach items="${messages }" var="message" varStatus="status">
						<a href="${ctx}/app/manager/messageDetail?msgId=${message.msgId}">
		...
		<footer>
			...
			<a class="msg_btn active" style="width: 25%;" href="${ctx}/app/manager/backlog/list">待办<div class="msg_countmine" style="right: 30%;">${toDoDealNum}</div></a>
			...
			$.ajax({
				...
				success:function(messagePage){
					...
					for(var i = 0; i< messagePage.length;i++){
						result +='<a href="${ctx}/app/manager/messageDetail?msgId='+messagePage[i].msgId+'">'
							   +'<li class="pad_left45 pad_rgt3 border_btm pad_btm5">'
