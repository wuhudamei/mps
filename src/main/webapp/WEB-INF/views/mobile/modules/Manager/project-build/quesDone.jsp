...
<body>
	<div class="">
		<header>
			<a class="back_btn" href="${ctx}/app/manager/problem/problem_report?orderId=${order.id}"></a>
		...
		<form id="jvForm" action="" method="post" enctype="multipart/form-data">
			...
			<input type="text" hidden="hidden" id="orderInstallItemId" name="orderInstallItemId" value="${id }">
				...
				<div class="bg_f bor_btm">
					...
					<div class="pics font0 clearfix">
						<div class="pic camera" id="camera" href="javascript:void(0)">
							<img src="${ctxStatic}/mobile/modules/Manager/images/append.png" alt=""> 
	...
	<div class="alertMask undis" id ="alert3">
		<div class="maskWrapper">
			<p class="col_3 maskTit">通知</p>
			<div class="font28 col_6 maskContent">问题上报成功，该问题影响工期...</div>
			<div class="maskBtns clearfix">
	...
	<div class="alertMask undis" id ="alert4">
		<div class="maskWrapper">
			<p class="col_3 maskTit">通知</p>
			<div class="font28 col_6 maskContent">问题上报成功，该问题不影响工期...</div>
			<div class="maskBtns clearfix">
				<a class="maskBtn font33 col_f"  onclick="backlast2()" href="javascript:;">我知道了</a>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function preview(file) {  
			...
			if (file.files && file.files[0]) {  
				...
				reader.onload = function(evt){
					$('<div class="pic"><img style="width:100%;height:2rem;" src="' + evt.target.result + '" onload="compresspic(this,uploadpic)" id= "'+num+'" /><a class="del_pic" href="javascript:void(0)">删除</a></div>').insertAfter('#camera');
				}    
		...
		function backlast2(){
			...
			window.location.href="${ctx}/app/manager/problem/problem_report?orderId="+orderId;
			...
			$.ajax({
	            ...
	            success: function(data){
	            	if(null!=data && data == "0"){
	            		...
	            		$("#alertRemarks").text("安装项id传送失败");
	            		$("#alert").show();
	            	}else{
	            		$("#alertRemarks").text("您刚刚提交过问题上报，请耐心等待五分钟后再次操作");
	            		$("#alert").show();
	            	}
	            }
			 }); 
		...
		function applySubmit(){
			...
			//上报提交表单
			var options ={
					url : "${ctx}/app/manager/problem/problem-submit",
					type: "post",
					success : function(data){
						
						$('body').waitMe('hide');
						if(null!=data && data=="11"){
							$("#alert3").show();
						}else if(data=="12"){
							$("#alert4").show();
						}else if(data=="1"){
