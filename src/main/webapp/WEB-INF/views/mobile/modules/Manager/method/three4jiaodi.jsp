...
<script id="contentListTpl" type="text/html">
	<div class="">
		<a class="item zhankai" href="javascript:;">排水工程：交底定位放线</a>
...
<script>
	$(function(){
		var noticeList = [{
  		title: '1.根据设计要求或客户要求，对设备、设施定位，对排水管道布局定位。',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '2.禁止移动原排水管路位置，如特殊情况排水需移位，应仔细核查安装位置是否正确，不可影响其它设备安装；（必须拍照）',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '3.厨房排水管≥φ75mm，淋浴、洗漱排水管、洗衣机排水管≥φ50mm，马桶、蹲便器排水管≥φ110mm；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '4.老房座厕管道口低的用110/75的UPVC变径处理；',
  		dw: '',
  		zgfs: '违：返工重做',
  		bcfr: ['质检员（分数/金额）：0', '项目经理（分数/金额）：0', '施工工人（分数/金额）：0']
  	},
  	{
  		title: '5.洗衣机下水管必须单独连接主管道，不得与其他用水设备连接；',
  		dw: '',
  		zgfs: '违：返工重做并罚款',
  		bcfr: ['质检员（分数/金额）：1分/20元', '项目经理（分数/金额）：1分/10元', '施工工人（分数/金额）：1分/20元']
  	}];
