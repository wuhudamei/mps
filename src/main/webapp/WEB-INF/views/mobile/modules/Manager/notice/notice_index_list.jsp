...
<div class="g-info">
	<div class="alls sec msg_sec g-message" style="margin-bottom: 300px;">
		...
		<nav class="msg_nav bg_f mar_btm2 font0">
			<a class="nav_a font30 col_6" href="${ctx}/app/manager/message"><span>系统通知</span></a>
	...
	<footer>
		<a class="home_btn" style="width: 25%;" href="${ctx}/app/manager/toindex">首页</a>
			<%-- <a class="queue_btn" style="width: 25%;" href="${ctx}/app/manager/backlog/list">待办</a> --%>
			<a class="queue_btn" style="width: 25%;" href="${ctx}/app/manager/backlog/list">待办<div class="msg_countmine" style="right: 30%;">${toDoDealNum}</div></a>
			<a class="msg_btn active" style="width: 25%;" href="javascript:void(0)">消息<div class="msg_countmine" style="right: 30%;">${unreadMessageNum}</div></a>
			<a class="mine_btn" style="width: 25%;" href="${ctx}/app/manager/indexMine">我的</a>
	</footer>
</div>
...
<script type="text/javascript">
	...
	function loadList(){
		...
		$.post("${ctx}/app/manager/queryLoadNoticePageList",{pageNo:$("#pageNo").val(),pageSize:6,receiverEmployeeId:${managerId}},function(result){
			var content = "";
			for(var i=0;i<result.list.length;i++){
				...
				content = content + "<a href='${ctx}/app/manager/queryNoticePageListDetail?id="+result.list[i].id+"'><li class='noread pad_left45 pad_rgt3 border_btm pad_btm5'>" +alreadContent+"<p class='title font30 col_3 pad_top3'>"+
