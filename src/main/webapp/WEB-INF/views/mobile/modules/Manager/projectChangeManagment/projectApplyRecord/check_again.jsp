...
<div class="g-review">
	...
	<form id="submitFormId">
		<section class="pad_top10 mar_btm50 font0" id = "myformDiv">
			<ul class="pad_top2 pad_btm2 bg_f pad_left3 pad_rgt3 shadow">
				<li class="line_hgt clearfix">
					<span class="intro_left">审核人　：</span>
					<p class="intro_right">${bill.checkManName }</p>
				</li>
				<li class="line_hgt clearfix">
					<span class="intro_left">审核日期：</span>
					<p class="intro_right"> <fmt:formatDate value="${bill.checkDate }" pattern="yyyy-MM-dd"/>   </p>
				</li>
				<li class="line_hgt clearfix">
					<span class="intro_left">审核状态：</span>
					<p class="intro_right">${bill.status }-${bill.statusName }</p>
				</li>
				<li class="line_hgt clearfix">
					<span class="intro_left">驳回原因：</span>
					<p class="intro_right">${bill.checkWords }</p>
				</li>
			</ul>


			<div class="mar_left3 mar_rgt3 mar_top3">
				...
				<c:forEach items="${itemList }" var="item">
					<ul id="${item.itemId}" class="pad_left3 pad_rgt3 pad_top3 pad_btm3 mar_top3 bg_f shadow">
						...
						<li class="mar_btm5 clearfix">
							...
							<input readonly="readonly" class="itemCount font24 col_6 wid_200 grey_border pad_top1 pad_btm1 mar_rgt2  bg_grey" type="text" value="${item.itemCount }" name="itemCount" onchange="setToal()">
						</li>
						<li class="mar_btm5 clearfix">
    ...
    function  submit(){
        ...
        if(($("#changeReason").val()=="")){
            ...
            if(count != null && count>=2){
                ...
                var options ={
                    url: "${ctx}/app/manager/changeManagement/reSubmitBill",
                    type: "post",
                    success:function(data){
                        if(data=="1"){
                            //成功
                            globalUtil.fn.alert('重新提报成功',2.0);
