                 ...
                 <c:forEach items="${procedureList }" var="procedure" varStatus="status">
					<c:if test="${procedure.budgetNumber !=0}">
		                 <div class="sec_bot">
		                    ...
		                    <p>
		                        <span> 工料费预算金额 ：</span><span>${procedure.synthesizePrice}元/${procedure.unit}*${procedure.budgetNumber}=${procedure.laborAuxiliaryMaterialsBudgetAmount}元</span>
		                    </p>
		                    <p>
		                        <span>辅料费预算金额：</span><span>${procedure.accessoriesPrice}元/${procedure.unit}*${procedure.budgetNumber}=${procedure.auxiliaryMaterialsBudgetAmount}元</span>
		                    </p>
		                    <p>
