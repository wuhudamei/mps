...
<body>
	<div class="font0">
		<header>
			<a class="back_btn" href="${ctx}/app/worker/guarMoneyList"></a>
			<h2 class="title">质保金上缴详情</h2>
		</header>
		<!-- /header -->
		<section class="pad_top88">
			...
			<ul class="pad_top3 pad_left3 pad_btm200 bor_btm bg_f">
				<li class="mar_btm24 clearfix"><span
					class="col_grey font28 flo_left spanRgt">上缴金额：</span>
					<p class="font28 col_3 pad_rgt3 flow">+${bizGuaranteeMoneyPaidUsed.guaranteeMoneyAmount}</p></li>
				<li class="mar_btm24 clearfix"><span
					class="col_grey font28 flo_left spanRgt">上缴时间：</span>
				...
				<li class="mar_btm24 clearfix"><span
					class="col_grey font28 flo_left spanRgt">上缴类型：</span>
