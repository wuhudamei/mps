            ...
            <div class="sec_list">
                ...
                <table>
                 	...
                 	<tbody>
                 		...
                 		<tr class="BackWhite">
                 			<td>辅料扣款</td>
                 			<td>-${bizOrderTaskpackageSettlement.auxiliaryMaterialsAmount}元</td>
                 		</tr>
                 		<tr>
                 			<td>沙子水泥扣款</td>
                 			<td>-<c:if test="${bizOrderTaskpackageSettlement.sandCementAmount==null || bizOrderTaskpackageSettlement.sandCementAmount<0}">0.0</c:if><c:if test="${bizOrderTaskpackageSettlement.sandCementAmount>0}">${bizOrderTaskpackageSettlement.sandCementAmount}</c:if>元</td>
                 		</tr>
                 		<tr class="BackWhite">
                 			<td>质保金扣款</td>
