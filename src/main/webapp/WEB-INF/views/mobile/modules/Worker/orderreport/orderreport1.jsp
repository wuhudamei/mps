...
function submit(){
	...
	//校验通过
        $.ajax({
            url : "${ctx}/app/worker/orderReport/orderReportSave",
            type : "post",
            ...
            success : function(data) {
                ...
                setTimeout("window.location.href='${ctx}/app/worker/orderReport/toOrderReportRecord'",2000)
...
function check_illegal(num){
    ...
    case 2 :
        ...
        if($("#customerPhoneId").val().trim().length!=11 || isNaN(($("#customerPhoneId").val()))||$("#customerPhoneId").val().trim().length<1){
            ...
            $.ajax({
                url : "${ctx}/app/worker/orderReport/checkCustomerPhone?customerPhone=" + $("#customerPhoneId").val(),
                type : "post",
                async: false,
                success : function(data) {
                    if (data == "0") {
