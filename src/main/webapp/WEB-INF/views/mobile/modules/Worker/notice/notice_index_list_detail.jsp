...
<div class="g-message">
	<header class="">
		<a class="back_btn" href="${ctx}/app/worker/notice/queryNoticePageList"></a>
		<h2 class="title">消息详情</h2>
	</header><!-- /header -->
	<section class="under font0 mar_btm5 pad_left3 pad_rgt3">
		<p class="font30 col_blue mar_top3 mar_btm4">${notice.noticeTitle}</p>
		<div class="font28 col_3 mar_btm5 line_hgt_em indent">
			${notice.noticeContent}
		</div>
		<p class="font24 col_6 align_rgt"><fmt:formatDate value="${notice.publishDatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
	</section>
</div>
...
<script type="text/javascript">
	$(function(){
		$.post("${ctx}/app/worker/notice/saveNoticeLog",{id:${notice.id}});
	});
	;(function($){
	    $(function(){
