...
<body>
	<div class="g-message g-info">
		...
		<footer>
			<a class="task_btn" href="${ctx}/app/worker/toindex1">首页</a>
			<a class="msg_btn active" href="javascript:void(0)">消息</a>
			<a class="mine_btn" href="${ctx}/app/worker/myindex1">我的</a>
		</footer>
	</div>
