...
<body>
	<div class="g-info">
		<div class="top">
			<div class="user_info">
				<img src="${ctxStatic}/mobile/modules/Worker/images/headimg.png"
					alt="headimg"> <span class="user_name">${worker.realname }</span>
				<div class="star">
		...
		<div class="sec mine_sec">
			<nav class="info_nav">
				<a href="javascript:void(0)"> <span class="number">${settled }</span>
					<span class="explain">已结算完任务包</span>
				</a> <a href="javascript:void(0)"> <span class="number">${settling }</span>
		...
		<footer>
			<a style="width: 50%;" class="home_btn" href="${ctx}/app/worker/toindex1">首页</a>
			<a style="width: 50%;" class="mine_btn active" href="javascript:void(0)">我的</a>
		</footer>
