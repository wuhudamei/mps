   ...
   <div class="bxy_setIndex_warp_con">
      ...
      <!--  <ul class="list_con">
           <li class="clearfix" id="clearCookie">
               ...
               <p class="fr"><i>512k</i><span class="icon_enter"></span></p>
           </li>
           <li class="clearfix">
               <p class="fl"><span class="icon_updata"></span>版本升级</p>
               <p class="fr"><span class="new_tip">New</span>当前版本 V1.0.0.1<span class="icon_enter"></span></p>
           </li>
       </ul> -->
...
<script type="text/javascript">
	...
	setupWebViewJavascriptBridge(function(bridge) {
			...
			var callbackButton = document.getElementById("clearBtn");
