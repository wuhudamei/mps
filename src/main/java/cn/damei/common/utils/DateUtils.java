...
//		System.out.println(time/(24*60*60*1000));
	...
	/**
	 * 获取指定时间 某月某日 的date （精确到年月日）
	 *
	 * @param date
	 * @param month
	 * @param day
     * 获取当年、当前月、的第一天 （date, 0, 0, 1）
     * 获取当年、当前月、的最后一天 （date, 0, 1, 0）
     * 获取当年、前一个月、的第一天 （date, 0, -1, 1）
     * 获取当年、前一个月、的最后一天 （date, 0, 0, 0）
     * 获取当年、下个月、的第一天 （date, 0, 1, 1）
     * 获取当年、下个月、的最后一天 （date, 0, 2, 0）
	 * @return 返回日期对象
	 */
