...
public class CheckSizeConstantUtil {
	...
	public static final String CHECK_SCALE_9_VALUE = "9";
	public static final String CHECK_SCALE_9_VALUE_REMARK = "钛镁门复尺";
	public static final String CHECK_SCALE_10_VALUE = "10";
	public static final String CHECK_SCALE_10_VALUE_REMARK = "淋浴房复尺";
