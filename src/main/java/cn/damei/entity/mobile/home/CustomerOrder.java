...
public class CustomerOrder extends DataEntity2<CustomerOrder>{
	...
	public List<OrderTeam> getWorks() {
		return works;
	}
	public void setWorks(List<OrderTeam> works) {
		this.works = works;
	}
}
