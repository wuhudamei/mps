...
public class BizOrderInstallDateCompared extends DataEntity2<BizOrderInstallDateCompared> {
	...
	public String getInstallDeplayDays() {
		return installDeplayDays;
	}

	public void setInstallDeplayDays(String installDeplayDays) {
		this.installDeplayDays = installDeplayDays;
	}
