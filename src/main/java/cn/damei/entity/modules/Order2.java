...
public class Order2 extends DataEntity2<Order2> {
	...
	public String getGetOrderPeople() {
		return getOrderPeople;
	}

	public void setGetOrderPeople(String getOrderPeople) {
		this.getOrderPeople = getOrderPeople;
	}
	...
	public String getNoDistribution() {
		return noDistribution;
	}

	public void setNoDistribution(String noDistribution) {
		this.noDistribution = noDistribution;
	}
