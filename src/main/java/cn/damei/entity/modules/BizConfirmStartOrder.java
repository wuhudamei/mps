...
public class BizConfirmStartOrder extends DataAuthorityEntityConfirm {
	...
	//jsp用到的字段
	private Date staCreateDate;//创建确认开工日期
	private String managerRealName;//项目经理
	private Integer deplayDays;//延期天数
	private String dicIsNeedSign;//自装客户是否签字
	private String staRemarks;//延期原因
	private String staIsSelfDecorateNeedSign;//自装是否需要客户签字 -- '0.否；1.是
	private Integer countPhotos;//确认开工图片
	private String staSelfDecorateDelayDays;
	private String orderStartWorkID;
	
	private String inspectorName;
	private String inspectorPhone;
	private String enginDepartName;//区域名字
