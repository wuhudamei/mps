...
public class BizOrderDisclose extends DataAuthorityEntityDisclose {
	...
	private Integer countPhoto;//图片总数
	private Integer orderDiscloseId;//现场交底ID
	
	private Date contractBegin;//合同开始日期
	private Date contractEnd;//合同结束日期
	
	private Date discloseBegin;//交底开始日期
	private Date discloseEnd;//交底结束日期
	
	private String managerRealName;//员工姓名
	private Date disCreateDate;//交底创建日起 
