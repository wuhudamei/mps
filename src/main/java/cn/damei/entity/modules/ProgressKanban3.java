...
public class ProgressKanban3 extends DataEntity2<ProgressKanban3> {
	...
	//jsp页面取值专用字段
	private String actualDelayDays;
	private String discloseDays;
	
	public ProgressKanban3() {}
	...
	public String getActualDelayDays() {
		return actualDelayDays;
	}

	public void setActualDelayDays(String actualDelayDays) {
		this.actualDelayDays = actualDelayDays;
	}

	public String getDiscloseDays() {
		return discloseDays;
	}

	public void setDiscloseDays(String discloseDays) {
		this.discloseDays = discloseDays;
	}
